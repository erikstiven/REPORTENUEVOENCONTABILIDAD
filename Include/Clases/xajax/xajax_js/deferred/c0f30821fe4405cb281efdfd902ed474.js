...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_cargar_arbol=function(){return xajax.request({xjxfun:'cargar_arbol'},{parameters:arguments});};xajax_verificaCondicion=function(){return xajax.request({xjxfun:'verificaCondicion'},{parameters:arguments});};xajax_reporte_excel=function(){return xajax.request({xjxfun:'reporte_excel'},{parameters:arguments});};xajax_cargar_categoria=function(){return xajax.request({xjxfun:'cargar_categoria'},{parameters:arguments});};xajax_cargar_marca=function(){return xajax.request({xjxfun:'cargar_marca'},{parameters:arguments});};xajax_cargar_fechas=function(){return xajax.request({xjxfun:'cargar_fechas'},{parameters:arguments});};xajax_control_centro_costo=function(){return xajax.request({xjxfun:'control_centro_costo'},{parameters:arguments});};