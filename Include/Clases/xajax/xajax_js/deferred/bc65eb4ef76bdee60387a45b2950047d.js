...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_eliminar=function(){return xajax.request({xjxfun:'eliminar'},{parameters:arguments});};xajax_cargar_sucu=function(){return xajax.request({xjxfun:'cargar_sucu'},{parameters:arguments});};xajax_cargar_eje=function(){return xajax.request({xjxfun:'cargar_eje'},{parameters:arguments});};xajax_cargar_tipo_doc=function(){return xajax.request({xjxfun:'cargar_tipo_doc'},{parameters:arguments});};xajax_cargar_prdo=function(){return xajax.request({xjxfun:'cargar_prdo'},{parameters:arguments});};xajax_cargar_saldo=function(){return xajax.request({xjxfun:'cargar_saldo'},{parameters:arguments});};