...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_cargar_menu=function(){return xajax.request({xjxfun:'cargar_menu'},{parameters:arguments});};xajax_cargar_sucu=function(){return xajax.request({xjxfun:'cargar_sucu'},{parameters:arguments});};xajax_cargar_opcion=function(){return xajax.request({xjxfun:'cargar_opcion'},{parameters:arguments});};xajax_cargar_check=function(){return xajax.request({xjxfun:'cargar_check'},{parameters:arguments});};