...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_autorizar_pedido=function(){return xajax.request({xjxfun:'autorizar_pedido'},{parameters:arguments});};xajax_anular_pedido=function(){return xajax.request({xjxfun:'anular_pedido'},{parameters:arguments});};xajax_form_adjuntos=function(){return xajax.request({xjxfun:'form_adjuntos'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_genera_formulario_detalle=function(){return xajax.request({xjxfun:'genera_formulario_detalle'},{parameters:arguments});};