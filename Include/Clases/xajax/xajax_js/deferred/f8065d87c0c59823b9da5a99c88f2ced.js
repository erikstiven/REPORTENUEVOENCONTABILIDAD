...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_genera_formulario_modifica_detalle=function(){return xajax.request({xjxfun:'genera_formulario_modifica_detalle'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_modificar=function(){return xajax.request({xjxfun:'modificar'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_consultar_gen=function(){return xajax.request({xjxfun:'consultar_gen'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_vitas_retencion=function(){return xajax.request({xjxfun:'vitas_retencion'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_genera_pdf_doc2=function(){return xajax.request({xjxfun:'genera_pdf_doc2'},{parameters:arguments});};xajax_vitas_retencion_inv=function(){return xajax.request({xjxfun:'vitas_retencion_inv'},{parameters:arguments});};xajax_liqCompras=function(){return xajax.request({xjxfun:'liqCompras'},{parameters:arguments});};xajax_update_comprobante=function(){return xajax.request({xjxfun:'update_comprobante'},{parameters:arguments});};xajax_update_comprobante_in=function(){return xajax.request({xjxfun:'update_comprobante_in'},{parameters:arguments});};xajax_eliminar_comprobante=function(){return xajax.request({xjxfun:'eliminar_comprobante'},{parameters:arguments});};xajax_parametros=function(){return xajax.request({xjxfun:'parametros'},{parameters:arguments});};xajax_calcular=function(){return xajax.request({xjxfun:'calcular'},{parameters:arguments});};xajax_genera_pdf_cheque=function(){return xajax.request({xjxfun:'genera_pdf_cheque'},{parameters:arguments});};xajax_update_comprobante_form1_in=function(){return xajax.request({xjxfun:'update_comprobante_form1_in'},{parameters:arguments});};xajax_cargar_lista_tran_cli_prov=function(){return xajax.request({xjxfun:'cargar_lista_tran_cli_prov'},{parameters:arguments});};xajax_update_comprobante_form2_in=function(){return xajax.request({xjxfun:'update_comprobante_form2_in'},{parameters:arguments});};xajax_eliminar_comprobante_form2_in=function(){return xajax.request({xjxfun:'eliminar_comprobante_form2_in'},{parameters:arguments});};xajax_numero_ret_form3=function(){return xajax.request({xjxfun:'numero_ret_form3'},{parameters:arguments});};xajax_update_comprobante_form3_in=function(){return xajax.request({xjxfun:'update_comprobante_form3_in'},{parameters:arguments});};xajax_eliminar_comprobante_form3_in=function(){return xajax.request({xjxfun:'eliminar_comprobante_form3_in'},{parameters:arguments});};xajax_update_comprobante_form5_in=function(){return xajax.request({xjxfun:'update_comprobante_form5_in'},{parameters:arguments});};