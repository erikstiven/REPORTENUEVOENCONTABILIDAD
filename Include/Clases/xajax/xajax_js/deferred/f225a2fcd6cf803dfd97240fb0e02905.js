...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_formulario=function(){return xajax.request({xjxfun:'formulario'},{parameters:arguments});};xajax_cargar_Sucursal=function(){return xajax.request({xjxfun:'cargar_Sucursal'},{parameters:arguments});};xajax_cargar_proveedor=function(){return xajax.request({xjxfun:'cargar_proveedor'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_muestra_detalle=function(){return xajax.request({xjxfun:'muestra_detalle'},{parameters:arguments});};xajax_quita_prove=function(){return xajax.request({xjxfun:'quita_prove'},{parameters:arguments});};