...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_ventas_dashboard_1=function(){return xajax.request({xjxfun:'ventas_dashboard_1'},{parameters:arguments});};xajax_ventas_dashboard_2=function(){return xajax.request({xjxfun:'ventas_dashboard_2'},{parameters:arguments});};xajax_ventas_dashboard_3=function(){return xajax.request({xjxfun:'ventas_dashboard_3'},{parameters:arguments});};xajax_ventas_dashboard_4=function(){return xajax.request({xjxfun:'ventas_dashboard_4'},{parameters:arguments});};xajax_sincronizar_dashboard=function(){return xajax.request({xjxfun:'sincronizar_dashboard'},{parameters:arguments});};xajax_ventas_dashboard_geografia=function(){return xajax.request({xjxfun:'ventas_dashboard_geografia'},{parameters:arguments});};