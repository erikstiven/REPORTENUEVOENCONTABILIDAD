...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_generar=function(){return xajax.request({xjxfun:'generar'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_f_filtro_ejercicio=function(){return xajax.request({xjxfun:'f_filtro_ejercicio'},{parameters:arguments});};xajax_f_filtro_periodo=function(){return xajax.request({xjxfun:'f_filtro_periodo'},{parameters:arguments});};xajax_f_filtro_sucursal=function(){return xajax.request({xjxfun:'f_filtro_sucursal'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_form_filtros=function(){return xajax.request({xjxfun:'form_filtros'},{parameters:arguments});};xajax_cargar_mes=function(){return xajax.request({xjxfun:'cargar_mes'},{parameters:arguments});};