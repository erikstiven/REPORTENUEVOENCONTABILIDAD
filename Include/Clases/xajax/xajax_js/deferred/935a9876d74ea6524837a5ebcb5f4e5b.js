...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_reporte_alitecno=function(){return xajax.request({xjxfun:'reporte_alitecno'},{parameters:arguments});};xajax_reporte_global=function(){return xajax.request({xjxfun:'reporte_global'},{parameters:arguments});};xajax_autorizar_pedido=function(){return xajax.request({xjxfun:'autorizar_pedido'},{parameters:arguments});};xajax_reporte_alitecno_sri=function(){return xajax.request({xjxfun:'reporte_alitecno_sri'},{parameters:arguments});};xajax_reporte_alitecno_old=function(){return xajax.request({xjxfun:'reporte_alitecno_old'},{parameters:arguments});};xajax_reporteATS=function(){return xajax.request({xjxfun:'reporteATS'},{parameters:arguments});};xajax_form_filtros=function(){return xajax.request({xjxfun:'form_filtros'},{parameters:arguments});};xajax_cargar_mes=function(){return xajax.request({xjxfun:'cargar_mes'},{parameters:arguments});};