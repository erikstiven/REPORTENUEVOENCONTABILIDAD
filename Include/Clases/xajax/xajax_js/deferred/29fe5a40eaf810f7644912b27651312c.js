...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_genera_detalle=function(){return xajax.request({xjxfun:'genera_detalle'},{parameters:arguments});};xajax_cerrar_pedido=function(){return xajax.request({xjxfun:'cerrar_pedido'},{parameters:arguments});};xajax_anular_pedido=function(){return xajax.request({xjxfun:'anular_pedido'},{parameters:arguments});};xajax_genera_cabecera_formulario_=function(){return xajax.request({xjxfun:'genera_cabecera_formulario_'},{parameters:arguments});};xajax_consultar_=function(){return xajax.request({xjxfun:'consultar_'},{parameters:arguments});};xajax_imprime_lote_pedidos=function(){return xajax.request({xjxfun:'imprime_lote_pedidos'},{parameters:arguments});};