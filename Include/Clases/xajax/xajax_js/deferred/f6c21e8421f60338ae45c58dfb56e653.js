...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_genera_formulario_modifica_detalle=function(){return xajax.request({xjxfun:'genera_formulario_modifica_detalle'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};xajax_genera_busqueda_cliente=function(){return xajax.request({xjxfun:'genera_busqueda_cliente'},{parameters:arguments});};xajax_buscar_cliente=function(){return xajax.request({xjxfun:'buscar_cliente'},{parameters:arguments});};xajax_queryConsolidadoFact=function(){return xajax.request({xjxfun:'queryConsolidadoFact'},{parameters:arguments});};xajax_viewFacturaClpv=function(){return xajax.request({xjxfun:'viewFacturaClpv'},{parameters:arguments});};xajax_consultarVentaProd=function(){return xajax.request({xjxfun:'consultarVentaProd'},{parameters:arguments});};xajax_consultarVentaEmpresa=function(){return xajax.request({xjxfun:'consultarVentaEmpresa'},{parameters:arguments});};xajax_consultarFormaPago=function(){return xajax.request({xjxfun:'consultarFormaPago'},{parameters:arguments});};xajax_consultarNotaCredito=function(){return xajax.request({xjxfun:'consultarNotaCredito'},{parameters:arguments});};xajax_consultarPorProducto=function(){return xajax.request({xjxfun:'consultarPorProducto'},{parameters:arguments});};xajax_consultarLote=function(){return xajax.request({xjxfun:'consultarLote'},{parameters:arguments});};xajax_filtroLineaNegocio=function(){return xajax.request({xjxfun:'filtroLineaNegocio'},{parameters:arguments});};xajax_consultarLineaNegocio=function(){return xajax.request({xjxfun:'consultarLineaNegocio'},{parameters:arguments});};xajax_estadoCuentaContrato=function(){return xajax.request({xjxfun:'estadoCuentaContrato'},{parameters:arguments});};xajax_consultarRecaudoExterno=function(){return xajax.request({xjxfun:'consultarRecaudoExterno'},{parameters:arguments});};xajax_consultarConsolidado=function(){return xajax.request({xjxfun:'consultarConsolidado'},{parameters:arguments});};xajax_consultarWhatsapp=function(){return xajax.request({xjxfun:'consultarWhatsapp'},{parameters:arguments});};xajax_consultarComisionReferidos=function(){return xajax.request({xjxfun:'consultarComisionReferidos'},{parameters:arguments});};xajax_consultarUsuarioFac=function(){return xajax.request({xjxfun:'consultarUsuarioFac'},{parameters:arguments});};xajax_consultarUsuarioConso=function(){return xajax.request({xjxfun:'consultarUsuarioConso'},{parameters:arguments});};xajax_consultarProfPe=function(){return xajax.request({xjxfun:'consultarProfPe'},{parameters:arguments});};xajax_consultarPedFac=function(){return xajax.request({xjxfun:'consultarPedFac'},{parameters:arguments});};xajax_consultarConPr=function(){return xajax.request({xjxfun:'consultarConPr'},{parameters:arguments});};xajax_consultarConPed=function(){return xajax.request({xjxfun:'consultarConPed'},{parameters:arguments});};