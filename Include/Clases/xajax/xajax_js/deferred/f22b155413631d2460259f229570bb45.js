...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_eliminar_firma_actual=function(){return xajax.request({xjxfun:'eliminar_firma_actual'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_guardar_cargo=function(){return xajax.request({xjxfun:'guardar_cargo'},{parameters:arguments});};xajax_actualizar_cargo_empl=function(){return xajax.request({xjxfun:'actualizar_cargo_empl'},{parameters:arguments});};xajax_actualizar_historia_salario=function(){return xajax.request({xjxfun:'actualizar_historia_salario'},{parameters:arguments});};xajax_borrar_historia_salario=function(){return xajax.request({xjxfun:'borrar_historia_salario'},{parameters:arguments});};xajax_cargar_cargos=function(){return xajax.request({xjxfun:'cargar_cargos'},{parameters:arguments});};xajax_cargar_cargos_e=function(){return xajax.request({xjxfun:'cargar_cargos_e'},{parameters:arguments});};xajax_cargarListaCiudad=function(){return xajax.request({xjxfun:'cargarListaCiudad'},{parameters:arguments});};xajax_exportarExcel=function(){return xajax.request({xjxfun:'exportarExcel'},{parameters:arguments});};xajax_cargarLista=function(){return xajax.request({xjxfun:'cargarLista'},{parameters:arguments});};xajax_abrir_archivo=function(){return xajax.request({xjxfun:'abrir_archivo'},{parameters:arguments});};xajax_cargos=function(){return xajax.request({xjxfun:'cargos'},{parameters:arguments});};xajax_genera_fomulario_cargo=function(){return xajax.request({xjxfun:'genera_fomulario_cargo'},{parameters:arguments});};xajax_cargar_historial_cargos=function(){return xajax.request({xjxfun:'cargar_historial_cargos'},{parameters:arguments});};xajax_cargar_cargo_historial=function(){return xajax.request({xjxfun:'cargar_cargo_historial'},{parameters:arguments});};xajax_guardar_cargos=function(){return xajax.request({xjxfun:'guardar_cargos'},{parameters:arguments});};xajax_guardar_pes_cargos=function(){return xajax.request({xjxfun:'guardar_pes_cargos'},{parameters:arguments});};xajax_rubros=function(){return xajax.request({xjxfun:'rubros'},{parameters:arguments});};xajax_generar_formulario_rubros=function(){return xajax.request({xjxfun:'generar_formulario_rubros'},{parameters:arguments});};xajax_guardar_rubros=function(){return xajax.request({xjxfun:'guardar_rubros'},{parameters:arguments});};xajax_guardar_pes_rubros=function(){return xajax.request({xjxfun:'guardar_pes_rubros'},{parameters:arguments});};xajax_consulta_rubros=function(){return xajax.request({xjxfun:'consulta_rubros'},{parameters:arguments});};xajax_consultar_pes_rubros=function(){return xajax.request({xjxfun:'consultar_pes_rubros'},{parameters:arguments});};xajax_cargasFamiliares=function(){return xajax.request({xjxfun:'cargasFamiliares'},{parameters:arguments});};xajax_genera_formulario_cargasFamiliares=function(){return xajax.request({xjxfun:'genera_formulario_cargasFamiliares'},{parameters:arguments});};xajax_guardar_pes_cargas=function(){return xajax.request({xjxfun:'guardar_pes_cargas'},{parameters:arguments});};xajax_guardar_cargas=function(){return xajax.request({xjxfun:'guardar_cargas'},{parameters:arguments});};xajax_cargar_pes_cargasf=function(){return xajax.request({xjxfun:'cargar_pes_cargasf'},{parameters:arguments});};xajax_cargosF_historia=function(){return xajax.request({xjxfun:'cargosF_historia'},{parameters:arguments});};xajax_cargofF_eliminar=function(){return xajax.request({xjxfun:'cargofF_eliminar'},{parameters:arguments});};xajax_cargosF_eliminar_f=function(){return xajax.request({xjxfun:'cargosF_eliminar_f'},{parameters:arguments});};xajax_adjuntos=function(){return xajax.request({xjxfun:'adjuntos'},{parameters:arguments});};xajax_generar_formulario_adjuntos=function(){return xajax.request({xjxfun:'generar_formulario_adjuntos'},{parameters:arguments});};xajax_guardar_adjunto=function(){return xajax.request({xjxfun:'guardar_adjunto'},{parameters:arguments});};xajax_adjunto_guardar=function(){return xajax.request({xjxfun:'adjunto_guardar'},{parameters:arguments});};xajax_adjuntos_cargar=function(){return xajax.request({xjxfun:'adjuntos_cargar'},{parameters:arguments});};xajax_cargar_adjuntos=function(){return xajax.request({xjxfun:'cargar_adjuntos'},{parameters:arguments});};xajax_mostrar_adjuntos=function(){return xajax.request({xjxfun:'mostrar_adjuntos'},{parameters:arguments});};xajax_adjuntos_mostrar=function(){return xajax.request({xjxfun:'adjuntos_mostrar'},{parameters:arguments});};xajax_telefono=function(){return xajax.request({xjxfun:'telefono'},{parameters:arguments});};xajax_telefono_empleado=function(){return xajax.request({xjxfun:'telefono_empleado'},{parameters:arguments});};xajax_genera_formulario_busqueda=function(){return xajax.request({xjxfun:'genera_formulario_busqueda'},{parameters:arguments});};xajax_mas_carga=function(){return xajax.request({xjxfun:'mas_carga'},{parameters:arguments});};xajax_mas_carga2=function(){return xajax.request({xjxfun:'mas_carga2'},{parameters:arguments});};xajax_mas_adjuto=function(){return xajax.request({xjxfun:'mas_adjuto'},{parameters:arguments});};xajax_quitar_adjunto=function(){return xajax.request({xjxfun:'quitar_adjunto'},{parameters:arguments});};xajax_quitar_carga=function(){return xajax.request({xjxfun:'quitar_carga'},{parameters:arguments});};xajax_carga_banco=function(){return xajax.request({xjxfun:'carga_banco'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_control_tran=function(){return xajax.request({xjxfun:'control_tran'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_guarda_pedido=function(){return xajax.request({xjxfun:'guarda_pedido'},{parameters:arguments});};xajax_actualiza_grid=function(){return xajax.request({xjxfun:'actualiza_grid'},{parameters:arguments});};xajax_total_grid=function(){return xajax.request({xjxfun:'total_grid'},{parameters:arguments});};xajax_herramientas_asignadas=function(){return xajax.request({xjxfun:'herramientas_asignadas'},{parameters:arguments});};xajax_historial_sala=function(){return xajax.request({xjxfun:'historial_sala'},{parameters:arguments});};xajax_centros_costos=function(){return xajax.request({xjxfun:'centros_costos'},{parameters:arguments});};xajax_guardar_centros=function(){return xajax.request({xjxfun:'guardar_centros'},{parameters:arguments});};xajax_sucursales_empl=function(){return xajax.request({xjxfun:'sucursales_empl'},{parameters:arguments});};xajax_guardar_sucu_empl=function(){return xajax.request({xjxfun:'guardar_sucu_empl'},{parameters:arguments});};xajax_eliminar_cargo_empl=function(){return xajax.request({xjxfun:'eliminar_cargo_empl'},{parameters:arguments});};xajax_cargar_grupos=function(){return xajax.request({xjxfun:'cargar_grupos'},{parameters:arguments});};xajax_buscar_ccsos_selec=function(){return xajax.request({xjxfun:'buscar_ccsos_selec'},{parameters:arguments});};xajax_editar_cargo_empl=function(){return xajax.request({xjxfun:'editar_cargo_empl'},{parameters:arguments});};xajax_certificado=function(){return xajax.request({xjxfun:'certificado'},{parameters:arguments});};xajax_certificado_cesante=function(){return xajax.request({xjxfun:'certificado_cesante'},{parameters:arguments});};xajax_anular_centros=function(){return xajax.request({xjxfun:'anular_centros'},{parameters:arguments});};xajax_existeEmpleado=function(){return xajax.request({xjxfun:'existeEmpleado'},{parameters:arguments});};