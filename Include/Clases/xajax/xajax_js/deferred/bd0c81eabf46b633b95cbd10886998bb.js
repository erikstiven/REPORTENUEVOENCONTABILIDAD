...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_genera_formulario_modifica_detalle=function(){return xajax.request({xjxfun:'genera_formulario_modifica_detalle'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_modificar=function(){return xajax.request({xjxfun:'modificar'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_agrega_modifica_grid_mp=function(){return xajax.request({xjxfun:'agrega_modifica_grid_mp'},{parameters:arguments});};xajax_mostrar_grid_mp=function(){return xajax.request({xjxfun:'mostrar_grid_mp'},{parameters:arguments});};xajax_elimina_detalle_mp=function(){return xajax.request({xjxfun:'elimina_detalle_mp'},{parameters:arguments});};xajax_cargar_grid_mp=function(){return xajax.request({xjxfun:'cargar_grid_mp'},{parameters:arguments});};xajax_agrega_modifica_grid_in=function(){return xajax.request({xjxfun:'agrega_modifica_grid_in'},{parameters:arguments});};xajax_mostrar_grid_in=function(){return xajax.request({xjxfun:'mostrar_grid_in'},{parameters:arguments});};xajax_elimina_detalle_in=function(){return xajax.request({xjxfun:'elimina_detalle_in'},{parameters:arguments});};xajax_cargar_grid_in=function(){return xajax.request({xjxfun:'cargar_grid_in'},{parameters:arguments});};