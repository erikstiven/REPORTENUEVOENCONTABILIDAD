...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_agregarCentroCostosPrincipal=function(){return xajax.request({xjxfun:'agregarCentroCostosPrincipal'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_eliminarCentroCostos=function(){return xajax.request({xjxfun:'eliminarCentroCostos'},{parameters:arguments});};xajax_editarCentroCostos=function(){return xajax.request({xjxfun:'editarCentroCostos'},{parameters:arguments});};xajax_agregarCentroCostos=function(){return xajax.request({xjxfun:'agregarCentroCostos'},{parameters:arguments});};xajax_validaCCostos=function(){return xajax.request({xjxfun:'validaCCostos'},{parameters:arguments});};xajax_abre_modal_elementos=function(){return xajax.request({xjxfun:'abre_modal_elementos'},{parameters:arguments});};xajax_consultar_elementos=function(){return xajax.request({xjxfun:'consultar_elementos'},{parameters:arguments});};xajax_guardar_elemento=function(){return xajax.request({xjxfun:'guardar_elemento'},{parameters:arguments});};xajax_eliminar_elemento=function(){return xajax.request({xjxfun:'eliminar_elemento'},{parameters:arguments});};