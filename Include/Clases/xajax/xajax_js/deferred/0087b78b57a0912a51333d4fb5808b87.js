...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_generar=function(){return xajax.request({xjxfun:'generar'},{parameters:arguments});};xajax_genera_modificar=function(){return xajax.request({xjxfun:'genera_modificar'},{parameters:arguments});};xajax_update=function(){return xajax.request({xjxfun:'update'},{parameters:arguments});};xajax_guardar_chk=function(){return xajax.request({xjxfun:'guardar_chk'},{parameters:arguments});};