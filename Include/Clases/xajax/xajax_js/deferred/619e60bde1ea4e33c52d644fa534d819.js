...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_agrega_modifica_grid_update=function(){return xajax.request({xjxfun:'agrega_modifica_grid_update'},{parameters:arguments});};xajax_actualiza_grid=function(){return xajax.request({xjxfun:'actualiza_grid'},{parameters:arguments});};xajax_mostrar_grid=function(){return xajax.request({xjxfun:'mostrar_grid'},{parameters:arguments});};xajax_cancelar_pedido=function(){return xajax.request({xjxfun:'cancelar_pedido'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_total_grid=function(){return xajax.request({xjxfun:'total_grid'},{parameters:arguments});};xajax_cargar_grid=function(){return xajax.request({xjxfun:'cargar_grid'},{parameters:arguments});};xajax_guarda_pedido=function(){return xajax.request({xjxfun:'guarda_pedido'},{parameters:arguments});};xajax_cargar_productos=function(){return xajax.request({xjxfun:'cargar_productos'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_buscar_productos=function(){return xajax.request({xjxfun:'buscar_productos'},{parameters:arguments});};xajax_get_producto_no_registrado=function(){return xajax.request({xjxfun:'get_producto_no_registrado'},{parameters:arguments});};xajax_actualizar_presupuesto=function(){return xajax.request({xjxfun:'actualizar_presupuesto'},{parameters:arguments});};xajax_modal_cargar_archivo=function(){return xajax.request({xjxfun:'modal_cargar_archivo'},{parameters:arguments});};xajax_cargar_ord_compra_respaldo=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo'},{parameters:arguments});};xajax_cargar_ord_compra=function(){return xajax.request({xjxfun:'cargar_ord_compra'},{parameters:arguments});};xajax_lista_pedidos=function(){return xajax.request({xjxfun:'lista_pedidos'},{parameters:arguments});};xajax_navegar_pedido=function(){return xajax.request({xjxfun:'navegar_pedido'},{parameters:arguments});};xajax_buscar_pedido_por_numero=function(){return xajax.request({xjxfun:'buscar_pedido_por_numero'},{parameters:arguments});};xajax_carga_pedido=function(){return xajax.request({xjxfun:'carga_pedido'},{parameters:arguments});};xajax_detalle_pedido=function(){return xajax.request({xjxfun:'detalle_pedido'},{parameters:arguments});};xajax_actualiza_pedido=function(){return xajax.request({xjxfun:'actualiza_pedido'},{parameters:arguments});};xajax_lista_pedidos_anulados=function(){return xajax.request({xjxfun:'lista_pedidos_anulados'},{parameters:arguments});};xajax_carga_anulado=function(){return xajax.request({xjxfun:'carga_anulado'},{parameters:arguments});};xajax_reporte_solicitudes=function(){return xajax.request({xjxfun:'reporte_solicitudes'},{parameters:arguments});};xajax_adjuntos_solicitud=function(){return xajax.request({xjxfun:'adjuntos_solicitud'},{parameters:arguments});};xajax_form_detalle=function(){return xajax.request({xjxfun:'form_detalle'},{parameters:arguments});};xajax_genera_pdf_doc_reporte=function(){return xajax.request({xjxfun:'genera_pdf_doc_reporte'},{parameters:arguments});};xajax_form_aprobaciones=function(){return xajax.request({xjxfun:'form_aprobaciones'},{parameters:arguments});};xajax_autorizar_solicitud=function(){return xajax.request({xjxfun:'autorizar_solicitud'},{parameters:arguments});};xajax_form_editar=function(){return xajax.request({xjxfun:'form_editar'},{parameters:arguments});};xajax_form_anular=function(){return xajax.request({xjxfun:'form_anular'},{parameters:arguments});};xajax_anular_solicitud=function(){return xajax.request({xjxfun:'anular_solicitud'},{parameters:arguments});};xajax_form_proforma_proveedores=function(){return xajax.request({xjxfun:'form_proforma_proveedores'},{parameters:arguments});};xajax_form_proveedores=function(){return xajax.request({xjxfun:'form_proveedores'},{parameters:arguments});};xajax_agregar_proveedor=function(){return xajax.request({xjxfun:'agregar_proveedor'},{parameters:arguments});};xajax_genera_busqueda_cliente=function(){return xajax.request({xjxfun:'genera_busqueda_cliente'},{parameters:arguments});};xajax_generar_proforma=function(){return xajax.request({xjxfun:'generar_proforma'},{parameters:arguments});};xajax_ingresar_precios_proforma=function(){return xajax.request({xjxfun:'ingresar_precios_proforma'},{parameters:arguments});};xajax_autorizar_precios_proforma=function(){return xajax.request({xjxfun:'autorizar_precios_proforma'},{parameters:arguments});};xajax_orden_compra_proforma=function(){return xajax.request({xjxfun:'orden_compra_proforma'},{parameters:arguments});};xajax_eliminar_prove=function(){return xajax.request({xjxfun:'eliminar_prove'},{parameters:arguments});};xajax_genera_pdf_cuadro=function(){return xajax.request({xjxfun:'genera_pdf_cuadro'},{parameters:arguments});};xajax_reporte_solicitudes_orden_compra=function(){return xajax.request({xjxfun:'reporte_solicitudes_orden_compra'},{parameters:arguments});};xajax_form_ordenes_proveedores=function(){return xajax.request({xjxfun:'form_ordenes_proveedores'},{parameters:arguments});};xajax_detalle_pedido_req=function(){return xajax.request({xjxfun:'detalle_pedido_req'},{parameters:arguments});};xajax_subtotal_prod=function(){return xajax.request({xjxfun:'subtotal_prod'},{parameters:arguments});};xajax_salvar=function(){return xajax.request({xjxfun:'salvar'},{parameters:arguments});};xajax_guardar_proforma=function(){return xajax.request({xjxfun:'guardar_proforma'},{parameters:arguments});};xajax_obtener_catalogo_aprobadores=function(){return xajax.request({xjxfun:'obtener_catalogo_aprobadores'},{parameters:arguments});};xajax_guardar_cargo_aprobador=function(){return xajax.request({xjxfun:'guardar_cargo_aprobador'},{parameters:arguments});};xajax_eliminar_cargo_aprobador=function(){return xajax.request({xjxfun:'eliminar_cargo_aprobador'},{parameters:arguments});};xajax_restaurar_cargo_aprobador=function(){return xajax.request({xjxfun:'restaurar_cargo_aprobador'},{parameters:arguments});};xajax_guardar_aprobador_modal=function(){return xajax.request({xjxfun:'guardar_aprobador_modal'},{parameters:arguments});};xajax_eliminar_aprobador_modal=function(){return xajax.request({xjxfun:'eliminar_aprobador_modal'},{parameters:arguments});};xajax_generar_codigo_auxiliar=function(){return xajax.request({xjxfun:'generar_codigo_auxiliar'},{parameters:arguments});};xajax_imprimirPedidoActual=function(){return xajax.request({xjxfun:'imprimirPedidoActual'},{parameters:arguments});};xajax_form_adjuntos_pedi=function(){return xajax.request({xjxfun:'form_adjuntos_pedi'},{parameters:arguments});};xajax_agregar_adjuntos_pedi=function(){return xajax.request({xjxfun:'agregar_adjuntos_pedi'},{parameters:arguments});};xajax_eliminar_adjunto_pedi=function(){return xajax.request({xjxfun:'eliminar_adjunto_pedi'},{parameters:arguments});};