...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_pdf_doc_compras=function(){return xajax.request({xjxfun:'genera_pdf_doc_compras'},{parameters:arguments});};xajax_abrir_modal_config_precios=function(){return xajax.request({xjxfun:'abrir_modal_config_precios'},{parameters:arguments});};xajax_calculo=function(){return xajax.request({xjxfun:'calculo'},{parameters:arguments});};xajax_ingreso_precios_fun_list=function(){return xajax.request({xjxfun:'ingreso_precios_fun_list'},{parameters:arguments});};xajax_modificarPrecios=function(){return xajax.request({xjxfun:'modificarPrecios'},{parameters:arguments});};