...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_ws=function(){return xajax.request({xjxfun:'genera_formulario_ws'},{parameters:arguments});};xajax_guardar_configuracion=function(){return xajax.request({xjxfun:'guardar_configuracion'},{parameters:arguments});};xajax_whatsapp_desconectar=function(){return xajax.request({xjxfun:'whatsapp_desconectar'},{parameters:arguments});};xajax_verificar_configuracion=function(){return xajax.request({xjxfun:'verificar_configuracion'},{parameters:arguments});};xajax_enviar_mensaje=function(){return xajax.request({xjxfun:'enviar_mensaje'},{parameters:arguments});};