...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_update_comprobante=function(){return xajax.request({xjxfun:'update_comprobante'},{parameters:arguments});};xajax_update_comprobante_in=function(){return xajax.request({xjxfun:'update_comprobante_in'},{parameters:arguments});};xajax_eliminar_comprobante=function(){return xajax.request({xjxfun:'eliminar_comprobante'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};