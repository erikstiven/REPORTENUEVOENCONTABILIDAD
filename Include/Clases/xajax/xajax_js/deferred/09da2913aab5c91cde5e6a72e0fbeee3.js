...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_formato=function(){return xajax.request({xjxfun:'formato'},{parameters:arguments});};xajax_verificaCondicion=function(){return xajax.request({xjxfun:'verificaCondicion'},{parameters:arguments});};xajax_procesarPrecios=function(){return xajax.request({xjxfun:'procesarPrecios'},{parameters:arguments});};xajax_copyPrecios=function(){return xajax.request({xjxfun:'copyPrecios'},{parameters:arguments});};