...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_generar=function(){return xajax.request({xjxfun:'generar'},{parameters:arguments});};xajax_f_filtro_mes=function(){return xajax.request({xjxfun:'f_filtro_mes'},{parameters:arguments});};xajax_f_filtro_grupo=function(){return xajax.request({xjxfun:'f_filtro_grupo'},{parameters:arguments});};xajax_f_filtro_subgrupo=function(){return xajax.request({xjxfun:'f_filtro_subgrupo'},{parameters:arguments});};xajax_f_filtro_activos_desde=function(){return xajax.request({xjxfun:'f_filtro_activos_desde'},{parameters:arguments});};xajax_f_filtro_activos_hasta=function(){return xajax.request({xjxfun:'f_filtro_activos_hasta'},{parameters:arguments});};xajax_f_filtro_sucursal=function(){return xajax.request({xjxfun:'f_filtro_sucursal'},{parameters:arguments});};xajax_f_filtro_anio=function(){return xajax.request({xjxfun:'f_filtro_anio'},{parameters:arguments});};