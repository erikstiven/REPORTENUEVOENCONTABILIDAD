...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_reporte=function(){return xajax.request({xjxfun:'genera_formulario_reporte'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_genera_formulario_retorno=function(){return xajax.request({xjxfun:'genera_formulario_retorno'},{parameters:arguments});};xajax_guardar_ret=function(){return xajax.request({xjxfun:'guardar_ret'},{parameters:arguments});};xajax_reporte_ret=function(){return xajax.request({xjxfun:'reporte_ret'},{parameters:arguments});};xajax_cargar_costos=function(){return xajax.request({xjxfun:'cargar_costos'},{parameters:arguments});};xajax_cargar_arbol=function(){return xajax.request({xjxfun:'cargar_arbol'},{parameters:arguments});};xajax_cargar_talla=function(){return xajax.request({xjxfun:'cargar_talla'},{parameters:arguments});};xajax_cargar_color=function(){return xajax.request({xjxfun:'cargar_color'},{parameters:arguments});};xajax_cargar_prod=function(){return xajax.request({xjxfun:'cargar_prod'},{parameters:arguments});};xajax_cargar_sucu=function(){return xajax.request({xjxfun:'cargar_sucu'},{parameters:arguments});};xajax_cargar_bodega=function(){return xajax.request({xjxfun:'cargar_bodega'},{parameters:arguments});};xajax_cargar_grupos=function(){return xajax.request({xjxfun:'cargar_grupos'},{parameters:arguments});};xajax_cargar_categorias=function(){return xajax.request({xjxfun:'cargar_categorias'},{parameters:arguments});};xajax_grabar=function(){return xajax.request({xjxfun:'grabar'},{parameters:arguments});};xajax_validar_cuentas=function(){return xajax.request({xjxfun:'validar_cuentas'},{parameters:arguments});};xajax_bajar_datos=function(){return xajax.request({xjxfun:'bajar_datos'},{parameters:arguments});};