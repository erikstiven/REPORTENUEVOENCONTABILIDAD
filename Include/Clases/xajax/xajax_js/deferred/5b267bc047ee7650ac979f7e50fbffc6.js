...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_reporte=function(){return xajax.request({xjxfun:'genera_formulario_reporte'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_genera_formulario_retorno=function(){return xajax.request({xjxfun:'genera_formulario_retorno'},{parameters:arguments});};xajax_cargar_costos=function(){return xajax.request({xjxfun:'cargar_costos'},{parameters:arguments});};xajax_cargar_arbol=function(){return xajax.request({xjxfun:'cargar_arbol'},{parameters:arguments});};xajax_cargar_bodega=function(){return xajax.request({xjxfun:'cargar_bodega'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_verDetalleMovimiento=function(){return xajax.request({xjxfun:'verDetalleMovimiento'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_producto_inventario=function(){return xajax.request({xjxfun:'producto_inventario'},{parameters:arguments});};xajax_asignar_cuenta=function(){return xajax.request({xjxfun:'asignar_cuenta'},{parameters:arguments});};