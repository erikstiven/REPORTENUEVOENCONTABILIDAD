...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_reporte=function(){return xajax.request({xjxfun:'genera_formulario_reporte'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_genera_formulario_detalle=function(){return xajax.request({xjxfun:'genera_formulario_detalle'},{parameters:arguments});};xajax_cargar_ret=function(){return xajax.request({xjxfun:'cargar_ret'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_mostrar_grid=function(){return xajax.request({xjxfun:'mostrar_grid'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_lote=function(){return xajax.request({xjxfun:'lote'},{parameters:arguments});};xajax_porc_ret=function(){return xajax.request({xjxfun:'porc_ret'},{parameters:arguments});};xajax_cargar_electronica=function(){return xajax.request({xjxfun:'cargar_electronica'},{parameters:arguments});};xajax_cargar_digito_ret=function(){return xajax.request({xjxfun:'cargar_digito_ret'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_orden_compra_reporte_det=function(){return xajax.request({xjxfun:'orden_compra_reporte_det'},{parameters:arguments});};xajax_modal_correo=function(){return xajax.request({xjxfun:'modal_correo'},{parameters:arguments});};xajax_envio_correo_sret=function(){return xajax.request({xjxfun:'envio_correo_sret'},{parameters:arguments});};