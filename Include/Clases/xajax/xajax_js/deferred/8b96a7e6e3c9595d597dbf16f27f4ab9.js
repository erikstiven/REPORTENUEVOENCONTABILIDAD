...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_busca_cliente=function(){return xajax.request({xjxfun:'busca_cliente'},{parameters:arguments});};xajax_producto_inventario=function(){return xajax.request({xjxfun:'producto_inventario'},{parameters:arguments});};xajax_generaGrid=function(){return xajax.request({xjxfun:'generaGrid'},{parameters:arguments});};xajax_formulario_factura=function(){return xajax.request({xjxfun:'formulario_factura'},{parameters:arguments});};xajax_formulario_detalle=function(){return xajax.request({xjxfun:'formulario_detalle'},{parameters:arguments});};xajax_gestiona_detalle=function(){return xajax.request({xjxfun:'gestiona_detalle'},{parameters:arguments});};xajax_modi_agre_detalle=function(){return xajax.request({xjxfun:'modi_agre_detalle'},{parameters:arguments});};xajax_mostrar_grid_totales=function(){return xajax.request({xjxfun:'mostrar_grid_totales'},{parameters:arguments});};xajax_recalcular_totales=function(){return xajax.request({xjxfun:'recalcular_totales'},{parameters:arguments});};xajax_gestiona_totales=function(){return xajax.request({xjxfun:'gestiona_totales'},{parameters:arguments});};xajax_mostrar_grid_dnc=function(){return xajax.request({xjxfun:'mostrar_grid_dnc'},{parameters:arguments});};xajax_pinta_valores=function(){return xajax.request({xjxfun:'pinta_valores'},{parameters:arguments});};xajax_formulario_ModificaDetalle=function(){return xajax.request({xjxfun:'formulario_ModificaDetalle'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_guarda_pedido=function(){return xajax.request({xjxfun:'guarda_pedido'},{parameters:arguments});};xajax_gestiona_notaCredito=function(){return xajax.request({xjxfun:'gestiona_notaCredito'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_formulario_solicitud=function(){return xajax.request({xjxfun:'formulario_solicitud'},{parameters:arguments});};xajax_cargar_detalle_solicitud=function(){return xajax.request({xjxfun:'cargar_detalle_solicitud'},{parameters:arguments});};xajax_num_digito_fact=function(){return xajax.request({xjxfun:'num_digito_fact'},{parameters:arguments});};xajax_guardar_punto_emision_usuario=function(){return xajax.request({xjxfun:'guardar_punto_emision_usuario'},{parameters:arguments});};xajax_cargar_lista_dire=function(){return xajax.request({xjxfun:'cargar_lista_dire'},{parameters:arguments});};xajax_genera_busqueda_cliente=function(){return xajax.request({xjxfun:'genera_busqueda_cliente'},{parameters:arguments});};