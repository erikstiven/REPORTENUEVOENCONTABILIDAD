...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_seleccionarTran=function(){return xajax.request({xjxfun:'seleccionarTran'},{parameters:arguments});};xajax_guardar_tran=function(){return xajax.request({xjxfun:'guardar_tran'},{parameters:arguments});};xajax_update_tran_frame=function(){return xajax.request({xjxfun:'update_tran_frame'},{parameters:arguments});};xajax_agregarEntidad=function(){return xajax.request({xjxfun:'agregarEntidad'},{parameters:arguments});};xajax_bodegas=function(){return xajax.request({xjxfun:'bodegas'},{parameters:arguments});};xajax_consultar_infoxml=function(){return xajax.request({xjxfun:'consultar_infoxml'},{parameters:arguments});};xajax_ingresar_detxml=function(){return xajax.request({xjxfun:'ingresar_detxml'},{parameters:arguments});};xajax_guardar_detxml=function(){return xajax.request({xjxfun:'guardar_detxml'},{parameters:arguments});};xajax_consultar_infopdf=function(){return xajax.request({xjxfun:'consultar_infopdf'},{parameters:arguments});};xajax_ingresar_detpdf=function(){return xajax.request({xjxfun:'ingresar_detpdf'},{parameters:arguments});};xajax_guardar_detpdf=function(){return xajax.request({xjxfun:'guardar_detpdf'},{parameters:arguments});};xajax_sincronizar_base=function(){return xajax.request({xjxfun:'sincronizar_base'},{parameters:arguments});};xajax_validar_firma=function(){return xajax.request({xjxfun:'validar_firma'},{parameters:arguments});};xajax_test_conexion_sftp_pichincha=function(){return xajax.request({xjxfun:'test_conexion_sftp_pichincha'},{parameters:arguments});};xajax_cargar_prov=function(){return xajax.request({xjxfun:'cargar_prov'},{parameters:arguments});};xajax_cargar_cant=function(){return xajax.request({xjxfun:'cargar_cant'},{parameters:arguments});};xajax_cargar_ciud=function(){return xajax.request({xjxfun:'cargar_ciud'},{parameters:arguments});};xajax_cargar_parr=function(){return xajax.request({xjxfun:'cargar_parr'},{parameters:arguments});};xajax_acciones_integracion=function(){return xajax.request({xjxfun:'acciones_integracion'},{parameters:arguments});};