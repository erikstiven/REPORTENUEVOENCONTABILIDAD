...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_menu=function(){return xajax.request({xjxfun:'genera_menu'},{parameters:arguments});};xajax_generaDashboard=function(){return xajax.request({xjxfun:'generaDashboard'},{parameters:arguments});};xajax_ventasEmpresa=function(){return xajax.request({xjxfun:'ventasEmpresa'},{parameters:arguments});};xajax_carteraEmpresa=function(){return xajax.request({xjxfun:'carteraEmpresa'},{parameters:arguments});};xajax_inventarioEmpresa=function(){return xajax.request({xjxfun:'inventarioEmpresa'},{parameters:arguments});};xajax_porPagarEmpresa=function(){return xajax.request({xjxfun:'porPagarEmpresa'},{parameters:arguments});};xajax_filtroVentas=function(){return xajax.request({xjxfun:'filtroVentas'},{parameters:arguments});};xajax_ventasFormaPago=function(){return xajax.request({xjxfun:'ventasFormaPago'},{parameters:arguments});};xajax_ventasFormaPagoGeneral=function(){return xajax.request({xjxfun:'ventasFormaPagoGeneral'},{parameters:arguments});};xajax_reportFormaPago=function(){return xajax.request({xjxfun:'reportFormaPago'},{parameters:arguments});};xajax_generaReportePago=function(){return xajax.request({xjxfun:'generaReportePago'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_detalleContratos=function(){return xajax.request({xjxfun:'detalleContratos'},{parameters:arguments});};xajax_estadoCuentaContrato=function(){return xajax.request({xjxfun:'estadoCuentaContrato'},{parameters:arguments});};xajax_detallePuertos=function(){return xajax.request({xjxfun:'detallePuertos'},{parameters:arguments});};xajax_reportPuertos=function(){return xajax.request({xjxfun:'reportPuertos'},{parameters:arguments});};xajax_mirarNotas=function(){return xajax.request({xjxfun:'mirarNotas'},{parameters:arguments});};xajax_consultarPeticiones=function(){return xajax.request({xjxfun:'consultarPeticiones'},{parameters:arguments});};xajax_mirarPeticion=function(){return xajax.request({xjxfun:'mirarPeticion'},{parameters:arguments});};xajax_ejecutar_peticion=function(){return xajax.request({xjxfun:'ejecutar_peticion'},{parameters:arguments});};xajax_marcarFavorito=function(){return xajax.request({xjxfun:'marcarFavorito'},{parameters:arguments});};xajax_buscar_filtro_producto=function(){return xajax.request({xjxfun:'buscar_filtro_producto'},{parameters:arguments});};xajax_stock_sucursal=function(){return xajax.request({xjxfun:'stock_sucursal'},{parameters:arguments});};xajax_eliminarFavorito=function(){return xajax.request({xjxfun:'eliminarFavorito'},{parameters:arguments});};xajax_cerrarNota=function(){return xajax.request({xjxfun:'cerrarNota'},{parameters:arguments});};xajax_guardar_tip_cambio_peru=function(){return xajax.request({xjxfun:'guardar_tip_cambio_peru'},{parameters:arguments});};xajax_auditar_ingreso_modulo=function(){return xajax.request({xjxfun:'auditar_ingreso_modulo'},{parameters:arguments});};xajax_guardar_tip_cambio_ws=function(){return xajax.request({xjxfun:'guardar_tip_cambio_ws'},{parameters:arguments});};xajax_mod_empr=function(){return xajax.request({xjxfun:'mod_empr'},{parameters:arguments});};