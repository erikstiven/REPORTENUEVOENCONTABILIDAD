...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_guardarEspecialidad=function(){return xajax.request({xjxfun:'guardarEspecialidad'},{parameters:arguments});};xajax_editarEspecialidad=function(){return xajax.request({xjxfun:'editarEspecialidad'},{parameters:arguments});};xajax_updateEspecialidad=function(){return xajax.request({xjxfun:'updateEspecialidad'},{parameters:arguments});};xajax_cargar_lista_asesor=function(){return xajax.request({xjxfun:'cargar_lista_asesor'},{parameters:arguments});};xajax_guardarAsesor=function(){return xajax.request({xjxfun:'guardarAsesor'},{parameters:arguments});};xajax_editarAsesor=function(){return xajax.request({xjxfun:'editarAsesor'},{parameters:arguments});};xajax_updateAsesor=function(){return xajax.request({xjxfun:'updateAsesor'},{parameters:arguments});};