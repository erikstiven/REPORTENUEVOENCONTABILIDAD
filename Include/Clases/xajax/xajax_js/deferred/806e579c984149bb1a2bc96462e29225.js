...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_nuevo=function(){return xajax.request({xjxfun:'nuevo'},{parameters:arguments});};xajax_eliminar=function(){return xajax.request({xjxfun:'eliminar'},{parameters:arguments});};xajax_caja=function(){return xajax.request({xjxfun:'caja'},{parameters:arguments});};xajax_asignar_cheques_cuentasb=function(){return xajax.request({xjxfun:'asignar_cheques_cuentasb'},{parameters:arguments});};xajax_guardar_cheques_cuentasb=function(){return xajax.request({xjxfun:'guardar_cheques_cuentasb'},{parameters:arguments});};xajax_editar_cheques_cuentasb=function(){return xajax.request({xjxfun:'editar_cheques_cuentasb'},{parameters:arguments});};xajax_nuevo_cheque=function(){return xajax.request({xjxfun:'nuevo_cheque'},{parameters:arguments});};