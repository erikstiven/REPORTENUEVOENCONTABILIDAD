...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_cargar_ord_compra_respaldo=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo'},{parameters:arguments});};xajax_guardar_usuario=function(){return xajax.request({xjxfun:'guardar_usuario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_borrar=function(){return xajax.request({xjxfun:'borrar'},{parameters:arguments});};xajax_parametros=function(){return xajax.request({xjxfun:'parametros'},{parameters:arguments});};xajax_actualiza_finca=function(){return xajax.request({xjxfun:'actualiza_finca'},{parameters:arguments});};xajax_borrar_finca=function(){return xajax.request({xjxfun:'borrar_finca'},{parameters:arguments});};xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_usuarios=function(){return xajax.request({xjxfun:'usuarios'},{parameters:arguments});};xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_imprimir_salida=function(){return xajax.request({xjxfun:'imprimir_salida'},{parameters:arguments});};