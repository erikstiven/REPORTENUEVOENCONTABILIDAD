...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_reporte_dias_vencer=function(){return xajax.request({xjxfun:'reporte_dias_vencer'},{parameters:arguments});};xajax_guardar_dias_vencer=function(){return xajax.request({xjxfun:'guardar_dias_vencer'},{parameters:arguments});};xajax_eliminar_dias_vencer=function(){return xajax.request({xjxfun:'eliminar_dias_vencer'},{parameters:arguments});};xajax_reporte_dias_vencidos=function(){return xajax.request({xjxfun:'reporte_dias_vencidos'},{parameters:arguments});};xajax_guardar_dias_vencidos=function(){return xajax.request({xjxfun:'guardar_dias_vencidos'},{parameters:arguments});};xajax_guardarCash=function(){return xajax.request({xjxfun:'guardarCash'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_paginacion=function(){return xajax.request({xjxfun:'paginacion'},{parameters:arguments});};xajax_genera_cash=function(){return xajax.request({xjxfun:'genera_cash'},{parameters:arguments});};xajax_eliminar_pago=function(){return xajax.request({xjxfun:'eliminar_pago'},{parameters:arguments});};xajax_cargar_pago=function(){return xajax.request({xjxfun:'cargar_pago'},{parameters:arguments});};xajax_f_filtro_sucursal=function(){return xajax.request({xjxfun:'f_filtro_sucursal'},{parameters:arguments});};xajax_archivo_ex=function(){return xajax.request({xjxfun:'archivo_ex'},{parameters:arguments});};xajax_cargar_campos_cash=function(){return xajax.request({xjxfun:'cargar_campos_cash'},{parameters:arguments});};xajax_cargar_campo_proceso=function(){return xajax.request({xjxfun:'cargar_campo_proceso'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};