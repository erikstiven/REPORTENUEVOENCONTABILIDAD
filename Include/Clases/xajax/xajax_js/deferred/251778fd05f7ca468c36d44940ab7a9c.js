...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_cargar_sucursal_existente=function(){return xajax.request({xjxfun:'cargar_sucursal_existente'},{parameters:arguments});};xajax_cargar_bodega_existente=function(){return xajax.request({xjxfun:'cargar_bodega_existente'},{parameters:arguments});};xajax_cargar_sucursal=function(){return xajax.request({xjxfun:'cargar_sucursal'},{parameters:arguments});};xajax_cargar_bodega=function(){return xajax.request({xjxfun:'cargar_bodega'},{parameters:arguments});};xajax_copiar_empresa=function(){return xajax.request({xjxfun:'copiar_empresa'},{parameters:arguments});};