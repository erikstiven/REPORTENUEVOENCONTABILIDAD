...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_generar=function(){return xajax.request({xjxfun:'generar'},{parameters:arguments});};xajax_f_filtro_sucursal=function(){return xajax.request({xjxfun:'f_filtro_sucursal'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_f_filtro_ciudad=function(){return xajax.request({xjxfun:'f_filtro_ciudad'},{parameters:arguments});};xajax_reporte_dias_vencer=function(){return xajax.request({xjxfun:'reporte_dias_vencer'},{parameters:arguments});};xajax_guardar_dias_vencer=function(){return xajax.request({xjxfun:'guardar_dias_vencer'},{parameters:arguments});};xajax_reporte_dias_vencidos=function(){return xajax.request({xjxfun:'reporte_dias_vencidos'},{parameters:arguments});};xajax_guardar_dias_vencidos=function(){return xajax.request({xjxfun:'guardar_dias_vencidos'},{parameters:arguments});};xajax_guardar_dias_vencidos=function(){return xajax.request({xjxfun:'guardar_dias_vencidos'},{parameters:arguments});};xajax_abrir_modal_facturas=function(){return xajax.request({xjxfun:'abrir_modal_facturas'},{parameters:arguments});};