...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_consultar_anulados=function(){return xajax.request({xjxfun:'consultar_anulados'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_borrar=function(){return xajax.request({xjxfun:'borrar'},{parameters:arguments});};xajax_editar=function(){return xajax.request({xjxfun:'editar'},{parameters:arguments});};xajax_actualizar=function(){return xajax.request({xjxfun:'actualizar'},{parameters:arguments});};xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_cargarListaSucursal=function(){return xajax.request({xjxfun:'cargarListaSucursal'},{parameters:arguments});};xajax_cargarListaBodega=function(){return xajax.request({xjxfun:'cargarListaBodega'},{parameters:arguments});};xajax_abre_modal_receta=function(){return xajax.request({xjxfun:'abre_modal_receta'},{parameters:arguments});};xajax_realizar_egreso=function(){return xajax.request({xjxfun:'realizar_egreso'},{parameters:arguments});};xajax_recalcular_total=function(){return xajax.request({xjxfun:'recalcular_total'},{parameters:arguments});};xajax_ver_prod_final=function(){return xajax.request({xjxfun:'ver_prod_final'},{parameters:arguments});};xajax_realizar_ingreso=function(){return xajax.request({xjxfun:'realizar_ingreso'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_pdf_doc_compras=function(){return xajax.request({xjxfun:'genera_pdf_doc_compras'},{parameters:arguments});};xajax_eliminar_movimiento=function(){return xajax.request({xjxfun:'eliminar_movimiento'},{parameters:arguments});};xajax_clientes_produccion=function(){return xajax.request({xjxfun:'clientes_produccion'},{parameters:arguments});};xajax_sincronizarTodasCuentas=function(){return xajax.request({xjxfun:'sincronizarTodasCuentas'},{parameters:arguments});};xajax_sincronizarCuenta=function(){return xajax.request({xjxfun:'sincronizarCuenta'},{parameters:arguments});};xajax_restaurar_movimiento=function(){return xajax.request({xjxfun:'restaurar_movimiento'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};