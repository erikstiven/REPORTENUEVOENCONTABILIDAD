...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_formulario_periodo=function(){return xajax.request({xjxfun:'formulario_periodo'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};xajax_detalle_solicitudes=function(){return xajax.request({xjxfun:'detalle_solicitudes'},{parameters:arguments});};xajax_consultar_detalles=function(){return xajax.request({xjxfun:'consultar_detalles'},{parameters:arguments});};xajax_form_detalle=function(){return xajax.request({xjxfun:'form_detalle'},{parameters:arguments});};xajax_adjuntos_solicitud=function(){return xajax.request({xjxfun:'adjuntos_solicitud'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_aprobaciones_solicitud=function(){return xajax.request({xjxfun:'aprobaciones_solicitud'},{parameters:arguments});};