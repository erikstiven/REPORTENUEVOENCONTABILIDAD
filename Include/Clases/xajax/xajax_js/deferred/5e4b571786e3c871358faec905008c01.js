...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_cargar_tipo=function(){return xajax.request({xjxfun:'cargar_tipo'},{parameters:arguments});};xajax_reporte_excel=function(){return xajax.request({xjxfun:'reporte_excel'},{parameters:arguments});};xajax_procesar_maestros=function(){return xajax.request({xjxfun:'procesar_maestros'},{parameters:arguments});};xajax_modal_datos=function(){return xajax.request({xjxfun:'modal_datos'},{parameters:arguments});};xajax_guardar_ciudad=function(){return xajax.request({xjxfun:'guardar_ciudad'},{parameters:arguments});};xajax_guardar_zona=function(){return xajax.request({xjxfun:'guardar_zona'},{parameters:arguments});};xajax_guardar_grupo=function(){return xajax.request({xjxfun:'guardar_grupo'},{parameters:arguments});};xajax_guardar_vendedor=function(){return xajax.request({xjxfun:'guardar_vendedor'},{parameters:arguments});};xajax_guardar_precio=function(){return xajax.request({xjxfun:'guardar_precio'},{parameters:arguments});};xajax_guardar_estado_civil=function(){return xajax.request({xjxfun:'guardar_estado_civil'},{parameters:arguments});};xajax_guardar_sexo=function(){return xajax.request({xjxfun:'guardar_sexo'},{parameters:arguments});};xajax_guardar_tsangre=function(){return xajax.request({xjxfun:'guardar_tsangre'},{parameters:arguments});};xajax_guardar_tcont=function(){return xajax.request({xjxfun:'guardar_tcont'},{parameters:arguments});};xajax_guardar_tpago=function(){return xajax.request({xjxfun:'guardar_tpago'},{parameters:arguments});};xajax_guardar_banco=function(){return xajax.request({xjxfun:'guardar_banco'},{parameters:arguments});};xajax_guardar_tcta=function(){return xajax.request({xjxfun:'guardar_tcta'},{parameters:arguments});};xajax_guardar_proyecto=function(){return xajax.request({xjxfun:'guardar_proyecto'},{parameters:arguments});};xajax_guardar_departamento=function(){return xajax.request({xjxfun:'guardar_departamento'},{parameters:arguments});};xajax_guardar_cargo=function(){return xajax.request({xjxfun:'guardar_cargo'},{parameters:arguments});};