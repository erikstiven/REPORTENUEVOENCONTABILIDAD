...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_genera_pdf_doc1=function(){return xajax.request({xjxfun:'genera_pdf_doc1'},{parameters:arguments});};xajax_genera_formulario_modifica_detalle=function(){return xajax.request({xjxfun:'genera_formulario_modifica_detalle'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_modificar=function(){return xajax.request({xjxfun:'modificar'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_consultar_gen=function(){return xajax.request({xjxfun:'consultar_gen'},{parameters:arguments});};xajax_form_prove_prod=function(){return xajax.request({xjxfun:'form_prove_prod'},{parameters:arguments});};xajax_form_adjuntos=function(){return xajax.request({xjxfun:'form_adjuntos'},{parameters:arguments});};xajax_form_editar=function(){return xajax.request({xjxfun:'form_editar'},{parameters:arguments});};xajax_form_adjuntos_prove=function(){return xajax.request({xjxfun:'form_adjuntos_prove'},{parameters:arguments});};xajax_form_adjuntos_proforma=function(){return xajax.request({xjxfun:'form_adjuntos_proforma'},{parameters:arguments});};xajax_guardar_clpv_prod=function(){return xajax.request({xjxfun:'guardar_clpv_prod'},{parameters:arguments});};xajax_guardar_pedido=function(){return xajax.request({xjxfun:'guardar_pedido'},{parameters:arguments});};xajax_comparativo=function(){return xajax.request({xjxfun:'comparativo'},{parameters:arguments});};xajax_busqueda_solicitud=function(){return xajax.request({xjxfun:'busqueda_solicitud'},{parameters:arguments});};xajax_form_periodos=function(){return xajax.request({xjxfun:'form_periodos'},{parameters:arguments});};