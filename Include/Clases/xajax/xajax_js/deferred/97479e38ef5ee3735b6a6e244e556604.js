...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_formato=function(){return xajax.request({xjxfun:'formato'},{parameters:arguments});};xajax_cambiaIva=function(){return xajax.request({xjxfun:'cambiaIva'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_cambioIvaEmpresa=function(){return xajax.request({xjxfun:'cambioIvaEmpresa'},{parameters:arguments});};xajax_guardarProcesoTotal=function(){return xajax.request({xjxfun:'guardarProcesoTotal'},{parameters:arguments});};