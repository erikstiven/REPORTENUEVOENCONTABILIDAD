...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_genera_formulario_modifica_detalle=function(){return xajax.request({xjxfun:'genera_formulario_modifica_detalle'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_modificar=function(){return xajax.request({xjxfun:'modificar'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_autocompletar_producto=function(){return xajax.request({xjxfun:'autocompletar_producto'},{parameters:arguments});};xajax_seleccion_item_producto=function(){return xajax.request({xjxfun:'seleccion_item_producto'},{parameters:arguments});};xajax_cargar_datos_producto=function(){return xajax.request({xjxfun:'cargar_datos_producto'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_agrega_modifica_grid_update=function(){return xajax.request({xjxfun:'agrega_modifica_grid_update'},{parameters:arguments});};xajax_actualiza_grid=function(){return xajax.request({xjxfun:'actualiza_grid'},{parameters:arguments});};xajax_mostrar_grid=function(){return xajax.request({xjxfun:'mostrar_grid'},{parameters:arguments});};xajax_cancelar_pedido=function(){return xajax.request({xjxfun:'cancelar_pedido'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_genera_formulario_detalle=function(){return xajax.request({xjxfun:'genera_formulario_detalle'},{parameters:arguments});};xajax_agregar_prod_cate=function(){return xajax.request({xjxfun:'agregar_prod_cate'},{parameters:arguments});};xajax_codigoOculto=function(){return xajax.request({xjxfun:'codigoOculto'},{parameters:arguments});};xajax_producto_inventario=function(){return xajax.request({xjxfun:'producto_inventario'},{parameters:arguments});};xajax_modificar_detalle=function(){return xajax.request({xjxfun:'modificar_detalle'},{parameters:arguments});};xajax_procesar_item=function(){return xajax.request({xjxfun:'procesar_item'},{parameters:arguments});};xajax_orden_servicio_form=function(){return xajax.request({xjxfun:'orden_servicio_form'},{parameters:arguments});};xajax_cargar_bodega=function(){return xajax.request({xjxfun:'cargar_bodega'},{parameters:arguments});};xajax_explosion_mp=function(){return xajax.request({xjxfun:'explosion_mp'},{parameters:arguments});};xajax_consultar_requ=function(){return xajax.request({xjxfun:'consultar_requ'},{parameters:arguments});};xajax_requisicion_det=function(){return xajax.request({xjxfun:'requisicion_det'},{parameters:arguments});};xajax_envio_correo=function(){return xajax.request({xjxfun:'envio_correo'},{parameters:arguments});};xajax_cargar_stock_bodega_transfiere=function(){return xajax.request({xjxfun:'cargar_stock_bodega_transfiere'},{parameters:arguments});};xajax_modal_subindices=function(){return xajax.request({xjxfun:'modal_subindices'},{parameters:arguments});};xajax_agregar_alias=function(){return xajax.request({xjxfun:'agregar_alias'},{parameters:arguments});};xajax_borrar_alias=function(){return xajax.request({xjxfun:'borrar_alias'},{parameters:arguments});};xajax_valida_existe_prod=function(){return xajax.request({xjxfun:'valida_existe_prod'},{parameters:arguments});};xajax_agrega_modifica_grid_sumar=function(){return xajax.request({xjxfun:'agrega_modifica_grid_sumar'},{parameters:arguments});};