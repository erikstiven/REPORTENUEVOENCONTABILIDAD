...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_generar=function(){return xajax.request({xjxfun:'generar'},{parameters:arguments});};xajax_f_filtro_ejercicio=function(){return xajax.request({xjxfun:'f_filtro_ejercicio'},{parameters:arguments});};xajax_f_filtro_periodo=function(){return xajax.request({xjxfun:'f_filtro_periodo'},{parameters:arguments});};xajax_f_filtro_sucursal=function(){return xajax.request({xjxfun:'f_filtro_sucursal'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_f_filtro_documento=function(){return xajax.request({xjxfun:'f_filtro_documento'},{parameters:arguments});};xajax_f_filtro=function(){return xajax.request({xjxfun:'f_filtro'},{parameters:arguments});};xajax_f_filtro_ciudad=function(){return xajax.request({xjxfun:'f_filtro_ciudad'},{parameters:arguments});};xajax_cargar_valor=function(){return xajax.request({xjxfun:'cargar_valor'},{parameters:arguments});};xajax_cuenta_bancaria=function(){return xajax.request({xjxfun:'cuenta_bancaria'},{parameters:arguments});};xajax_guardar_cuenta_prove=function(){return xajax.request({xjxfun:'guardar_cuenta_prove'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_cargar_pago=function(){return xajax.request({xjxfun:'cargar_pago'},{parameters:arguments});};xajax_eliminar_pago=function(){return xajax.request({xjxfun:'eliminar_pago'},{parameters:arguments});};xajax_genera_cash=function(){return xajax.request({xjxfun:'genera_cash'},{parameters:arguments});};xajax_cambiar_banco_pago=function(){return xajax.request({xjxfun:'cambiar_banco_pago'},{parameters:arguments});};xajax_cargar_campos_cash=function(){return xajax.request({xjxfun:'cargar_campos_cash'},{parameters:arguments});};xajax_cargar_campo_proceso=function(){return xajax.request({xjxfun:'cargar_campo_proceso'},{parameters:arguments});};xajax_actualiza_cash=function(){return xajax.request({xjxfun:'actualiza_cash'},{parameters:arguments});};xajax_agregar_cuenta=function(){return xajax.request({xjxfun:'agregar_cuenta'},{parameters:arguments});};