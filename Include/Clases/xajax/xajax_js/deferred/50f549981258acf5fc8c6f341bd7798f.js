...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_diario=function(){return xajax.request({xjxfun:'diario'},{parameters:arguments});};xajax_mostrar_grid_dia=function(){return xajax.request({xjxfun:'mostrar_grid_dia'},{parameters:arguments});};xajax_elimina_detalle_dia=function(){return xajax.request({xjxfun:'elimina_detalle_dia'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};