...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};xajax_guardarEstado=function(){return xajax.request({xjxfun:'guardarEstado'},{parameters:arguments});};xajax_genera_busqueda_cuenta=function(){return xajax.request({xjxfun:'genera_busqueda_cuenta'},{parameters:arguments});};xajax_generaformularioDasi=function(){return xajax.request({xjxfun:'generaformularioDasi'},{parameters:arguments});};xajax_generaformularioDir=function(){return xajax.request({xjxfun:'generaformularioDir'},{parameters:arguments});};xajax_generaformularioRete=function(){return xajax.request({xjxfun:'generaformularioRete'},{parameters:arguments});};xajax_generaformularioFprv=function(){return xajax.request({xjxfun:'generaformularioFprv'},{parameters:arguments});};xajax_abrirArchivo=function(){return xajax.request({xjxfun:'abrirArchivo'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_generaformularioDmcp=function(){return xajax.request({xjxfun:'generaformularioDmcp'},{parameters:arguments});};xajax_numero_cuenta_b=function(){return xajax.request({xjxfun:'numero_cuenta_b'},{parameters:arguments});};xajax_edita_asto=function(){return xajax.request({xjxfun:'edita_asto'},{parameters:arguments});};xajax_actualiza_deposito=function(){return xajax.request({xjxfun:'actualiza_deposito'},{parameters:arguments});};xajax_ordena=function(){return xajax.request({xjxfun:'ordena'},{parameters:arguments});};xajax_ordena2=function(){return xajax.request({xjxfun:'ordena2'},{parameters:arguments});};xajax_pdf=function(){return xajax.request({xjxfun:'pdf'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};