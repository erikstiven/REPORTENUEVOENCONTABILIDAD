...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_generar=function(){return xajax.request({xjxfun:'generar'},{parameters:arguments});};xajax_reporteArchivoExcel=function(){return xajax.request({xjxfun:'reporteArchivoExcel'},{parameters:arguments});};xajax_guardarFacturas=function(){return xajax.request({xjxfun:'guardarFacturas'},{parameters:arguments});};xajax_detalleRetenciones=function(){return xajax.request({xjxfun:'detalleRetenciones'},{parameters:arguments});};