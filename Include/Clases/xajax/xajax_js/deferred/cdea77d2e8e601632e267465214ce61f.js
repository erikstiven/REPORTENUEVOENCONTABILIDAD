...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_reporte=function(){return xajax.request({xjxfun:'genera_formulario_reporte'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_check_bodega=function(){return xajax.request({xjxfun:'check_bodega'},{parameters:arguments});};xajax_genera_formulario_retorno=function(){return xajax.request({xjxfun:'genera_formulario_retorno'},{parameters:arguments});};xajax_guardar_ret=function(){return xajax.request({xjxfun:'guardar_ret'},{parameters:arguments});};xajax_reporte_ret=function(){return xajax.request({xjxfun:'reporte_ret'},{parameters:arguments});};xajax_cargar_costos=function(){return xajax.request({xjxfun:'cargar_costos'},{parameters:arguments});};xajax_cargar_arbol=function(){return xajax.request({xjxfun:'cargar_arbol'},{parameters:arguments});};xajax_cargar_bode=function(){return xajax.request({xjxfun:'cargar_bode'},{parameters:arguments});};xajax_cargar_talla=function(){return xajax.request({xjxfun:'cargar_talla'},{parameters:arguments});};xajax_cargar_color=function(){return xajax.request({xjxfun:'cargar_color'},{parameters:arguments});};xajax_ctrl_prod_cod=function(){return xajax.request({xjxfun:'ctrl_prod_cod'},{parameters:arguments});};xajax_cargar_check=function(){return xajax.request({xjxfun:'cargar_check'},{parameters:arguments});};xajax_productoBodega=function(){return xajax.request({xjxfun:'productoBodega'},{parameters:arguments});};xajax_listaProdServCliente=function(){return xajax.request({xjxfun:'listaProdServCliente'},{parameters:arguments});};xajax_cargarlistaProdServ=function(){return xajax.request({xjxfun:'cargarlistaProdServ'},{parameters:arguments});};xajax_guardarProdServ=function(){return xajax.request({xjxfun:'guardarProdServ'},{parameters:arguments});};xajax_eliminarProdServ=function(){return xajax.request({xjxfun:'eliminarProdServ'},{parameters:arguments});};xajax_modificarProdServ=function(){return xajax.request({xjxfun:'modificarProdServ'},{parameters:arguments});};xajax_cargar_prod=function(){return xajax.request({xjxfun:'cargar_prod'},{parameters:arguments});};xajax_cargar_grupo=function(){return xajax.request({xjxfun:'cargar_grupo'},{parameters:arguments});};xajax_cargar_cate=function(){return xajax.request({xjxfun:'cargar_cate'},{parameters:arguments});};xajax_cargar_marca=function(){return xajax.request({xjxfun:'cargar_marca'},{parameters:arguments});};xajax_arbolInventario=function(){return xajax.request({xjxfun:'arbolInventario'},{parameters:arguments});};xajax_genera_marca=function(){return xajax.request({xjxfun:'genera_marca'},{parameters:arguments});};xajax_guardar_marca=function(){return xajax.request({xjxfun:'guardar_marca'},{parameters:arguments});};xajax_modificarPrecios=function(){return xajax.request({xjxfun:'modificarPrecios'},{parameters:arguments});};xajax_ver_imagen=function(){return xajax.request({xjxfun:'ver_imagen'},{parameters:arguments});};xajax_cargar_marca_dispo=function(){return xajax.request({xjxfun:'cargar_marca_dispo'},{parameters:arguments});};xajax_cargar_dispo=function(){return xajax.request({xjxfun:'cargar_dispo'},{parameters:arguments});};xajax_guardar_producto_modelo=function(){return xajax.request({xjxfun:'guardar_producto_modelo'},{parameters:arguments});};xajax_recarga_producto_marca=function(){return xajax.request({xjxfun:'recarga_producto_marca'},{parameters:arguments});};xajax_cargar_modelos=function(){return xajax.request({xjxfun:'cargar_modelos'},{parameters:arguments});};xajax_ubicaciones=function(){return xajax.request({xjxfun:'ubicaciones'},{parameters:arguments});};xajax_sincronizarClases=function(){return xajax.request({xjxfun:'sincronizarClases'},{parameters:arguments});};xajax_sincronizarVista=function(){return xajax.request({xjxfun:'sincronizarVista'},{parameters:arguments});};xajax_busca_prod_compras=function(){return xajax.request({xjxfun:'busca_prod_compras'},{parameters:arguments});};xajax_seleccionar_bodegas=function(){return xajax.request({xjxfun:'seleccionar_bodegas'},{parameters:arguments});};xajax_generar_qr=function(){return xajax.request({xjxfun:'generar_qr'},{parameters:arguments});};xajax_generar_cod_barra=function(){return xajax.request({xjxfun:'generar_cod_barra'},{parameters:arguments});};xajax_validar_codigo_barras=function(){return xajax.request({xjxfun:'validar_codigo_barras'},{parameters:arguments});};xajax_sincronizarArbol=function(){return xajax.request({xjxfun:'sincronizarArbol'},{parameters:arguments});};xajax_sincronizarArbol2=function(){return xajax.request({xjxfun:'sincronizarArbol2'},{parameters:arguments});};