...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_consultar_13=function(){return xajax.request({xjxfun:'consultar_13'},{parameters:arguments});};xajax_formato=function(){return xajax.request({xjxfun:'formato'},{parameters:arguments});};xajax_genera_formulario_pedido_1=function(){return xajax.request({xjxfun:'genera_formulario_pedido_1'},{parameters:arguments});};xajax_consultar_1=function(){return xajax.request({xjxfun:'consultar_1'},{parameters:arguments});};xajax_formato_1=function(){return xajax.request({xjxfun:'formato_1'},{parameters:arguments});};xajax_genera_formulario_pedido_2=function(){return xajax.request({xjxfun:'genera_formulario_pedido_2'},{parameters:arguments});};xajax_consultar_2=function(){return xajax.request({xjxfun:'consultar_2'},{parameters:arguments});};xajax_formato_2=function(){return xajax.request({xjxfun:'formato_2'},{parameters:arguments});};xajax_genera_formulario_pedido_3=function(){return xajax.request({xjxfun:'genera_formulario_pedido_3'},{parameters:arguments});};xajax_consultar_3=function(){return xajax.request({xjxfun:'consultar_3'},{parameters:arguments});};xajax_formato_3=function(){return xajax.request({xjxfun:'formato_3'},{parameters:arguments});};xajax_genera_formulario_pedido_4=function(){return xajax.request({xjxfun:'genera_formulario_pedido_4'},{parameters:arguments});};xajax_consultar_4=function(){return xajax.request({xjxfun:'consultar_4'},{parameters:arguments});};xajax_formato_4=function(){return xajax.request({xjxfun:'formato_4'},{parameters:arguments});};xajax_genera_formulario_pedido_5=function(){return xajax.request({xjxfun:'genera_formulario_pedido_5'},{parameters:arguments});};xajax_consultar_5=function(){return xajax.request({xjxfun:'consultar_5'},{parameters:arguments});};xajax_consultar_6=function(){return xajax.request({xjxfun:'consultar_6'},{parameters:arguments});};xajax_formato_5=function(){return xajax.request({xjxfun:'formato_5'},{parameters:arguments});};xajax_genera_formulario_pedido_6=function(){return xajax.request({xjxfun:'genera_formulario_pedido_6'},{parameters:arguments});};xajax_consultar_7=function(){return xajax.request({xjxfun:'consultar_7'},{parameters:arguments});};xajax_consultar_8=function(){return xajax.request({xjxfun:'consultar_8'},{parameters:arguments});};xajax_filtro_prodclpv=function(){return xajax.request({xjxfun:'filtro_prodclpv'},{parameters:arguments});};xajax_cargar_clpv=function(){return xajax.request({xjxfun:'cargar_clpv'},{parameters:arguments});};xajax_filtro_clpvprod=function(){return xajax.request({xjxfun:'filtro_clpvprod'},{parameters:arguments});};xajax_cargar_prod=function(){return xajax.request({xjxfun:'cargar_prod'},{parameters:arguments});};xajax_genera_formulario_pedido_7=function(){return xajax.request({xjxfun:'genera_formulario_pedido_7'},{parameters:arguments});};xajax_consultar_9=function(){return xajax.request({xjxfun:'consultar_9'},{parameters:arguments});};xajax_formato_7=function(){return xajax.request({xjxfun:'formato_7'},{parameters:arguments});};xajax_genera_formulario_pedido_8=function(){return xajax.request({xjxfun:'genera_formulario_pedido_8'},{parameters:arguments});};xajax_consultar_10=function(){return xajax.request({xjxfun:'consultar_10'},{parameters:arguments});};xajax_formato_8=function(){return xajax.request({xjxfun:'formato_8'},{parameters:arguments});};xajax_genera_formulario_pedido_9=function(){return xajax.request({xjxfun:'genera_formulario_pedido_9'},{parameters:arguments});};xajax_consultar_11=function(){return xajax.request({xjxfun:'consultar_11'},{parameters:arguments});};xajax_consultar_12=function(){return xajax.request({xjxfun:'consultar_12'},{parameters:arguments});};xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_reporte_linea=function(){return xajax.request({xjxfun:'reporte_linea'},{parameters:arguments});};xajax_Mes=function(){return xajax.request({xjxfun:'Mes'},{parameters:arguments});};xajax_genera_formulario_linea=function(){return xajax.request({xjxfun:'genera_formulario_linea'},{parameters:arguments});};xajax_reporte_linea_inventario=function(){return xajax.request({xjxfun:'reporte_linea_inventario'},{parameters:arguments});};