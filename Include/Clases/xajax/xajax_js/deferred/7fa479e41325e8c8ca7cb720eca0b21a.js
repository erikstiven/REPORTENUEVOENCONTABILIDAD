...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_busqueda_cliente=function(){return xajax.request({xjxfun:'genera_busqueda_cliente'},{parameters:arguments});};xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_cargar_Sucursal=function(){return xajax.request({xjxfun:'cargar_Sucursal'},{parameters:arguments});};xajax_cargar_proveedor=function(){return xajax.request({xjxfun:'cargar_proveedor'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_detalle_factura=function(){return xajax.request({xjxfun:'detalle_factura'},{parameters:arguments});};xajax_quita_prove=function(){return xajax.request({xjxfun:'quita_prove'},{parameters:arguments});};xajax_detalle_factura_linea=function(){return xajax.request({xjxfun:'detalle_factura_linea'},{parameters:arguments});};xajax_cargar_vendedor=function(){return xajax.request({xjxfun:'cargar_vendedor'},{parameters:arguments});};xajax_cargar_usuario=function(){return xajax.request({xjxfun:'cargar_usuario'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_detalle_cobro=function(){return xajax.request({xjxfun:'detalle_cobro'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_cargaMes=function(){return xajax.request({xjxfun:'cargaMes'},{parameters:arguments});};