...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_clpv_reporte=function(){return xajax.request({xjxfun:'clpv_reporte'},{parameters:arguments});};xajax_reporte_compras=function(){return xajax.request({xjxfun:'reporte_compras'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};