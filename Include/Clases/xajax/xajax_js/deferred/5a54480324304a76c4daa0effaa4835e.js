...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_editar=function(){return xajax.request({xjxfun:'editar'},{parameters:arguments});};xajax_obtenerSiglaDire=function(){return xajax.request({xjxfun:'obtenerSiglaDire'},{parameters:arguments});};xajax_cargar_lista_ruta=function(){return xajax.request({xjxfun:'cargar_lista_ruta'},{parameters:arguments});};xajax_cargar_lista_sectores=function(){return xajax.request({xjxfun:'cargar_lista_sectores'},{parameters:arguments});};