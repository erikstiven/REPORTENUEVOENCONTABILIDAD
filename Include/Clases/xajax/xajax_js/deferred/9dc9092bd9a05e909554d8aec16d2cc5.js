...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_reporte=function(){return xajax.request({xjxfun:'genera_formulario_reporte'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_genera_formulario_retorno=function(){return xajax.request({xjxfun:'genera_formulario_retorno'},{parameters:arguments});};xajax_guardar_ret=function(){return xajax.request({xjxfun:'guardar_ret'},{parameters:arguments});};xajax_reporte_ret=function(){return xajax.request({xjxfun:'reporte_ret'},{parameters:arguments});};xajax_cargar_costos=function(){return xajax.request({xjxfun:'cargar_costos'},{parameters:arguments});};xajax_cargar_arbol=function(){return xajax.request({xjxfun:'cargar_arbol'},{parameters:arguments});};xajax_cargar_bode=function(){return xajax.request({xjxfun:'cargar_bode'},{parameters:arguments});};xajax_cargar_talla=function(){return xajax.request({xjxfun:'cargar_talla'},{parameters:arguments});};xajax_cargar_color=function(){return xajax.request({xjxfun:'cargar_color'},{parameters:arguments});};xajax_reporte_kardex=function(){return xajax.request({xjxfun:'reporte_kardex'},{parameters:arguments});};xajax_verDetalleMovimiento=function(){return xajax.request({xjxfun:'verDetalleMovimiento'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_reporte_kardex_pdf=function(){return xajax.request({xjxfun:'reporte_kardex_pdf'},{parameters:arguments});};xajax_sincronizar_costos=function(){return xajax.request({xjxfun:'sincronizar_costos'},{parameters:arguments});};xajax_sincronizar_costos_all=function(){return xajax.request({xjxfun:'sincronizar_costos_all'},{parameters:arguments});};xajax_guardar_cantidades_actualizadas=function(){return xajax.request({xjxfun:'guardar_cantidades_actualizadas'},{parameters:arguments});};