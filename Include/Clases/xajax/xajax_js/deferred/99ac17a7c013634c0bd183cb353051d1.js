...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_cambioMetodoJs=function(){return xajax.request({xjxfun:'cambioMetodoJs'},{parameters:arguments});};xajax_cargar_consumidor_final=function(){return xajax.request({xjxfun:'cargar_consumidor_final'},{parameters:arguments});};xajax_cargar_lista_subcliente=function(){return xajax.request({xjxfun:'cargar_lista_subcliente'},{parameters:arguments});};xajax_cargar_datos=function(){return xajax.request({xjxfun:'cargar_datos'},{parameters:arguments});};xajax_limiteCredito=function(){return xajax.request({xjxfun:'limiteCredito'},{parameters:arguments});};xajax_datos_subcliente=function(){return xajax.request({xjxfun:'datos_subcliente'},{parameters:arguments});};xajax_cargar_lista_correo=function(){return xajax.request({xjxfun:'cargar_lista_correo'},{parameters:arguments});};xajax_cargar_lista_precio=function(){return xajax.request({xjxfun:'cargar_lista_precio'},{parameters:arguments});};xajax_cargar_lista_especialidad=function(){return xajax.request({xjxfun:'cargar_lista_especialidad'},{parameters:arguments});};xajax_genera_busqueda_cliente=function(){return xajax.request({xjxfun:'genera_busqueda_cliente'},{parameters:arguments});};xajax_validar_prod=function(){return xajax.request({xjxfun:'validar_prod'},{parameters:arguments});};xajax_validar_prod_barras=function(){return xajax.request({xjxfun:'validar_prod_barras'},{parameters:arguments});};xajax_buscar_filtro_producto=function(){return xajax.request({xjxfun:'buscar_filtro_producto'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_mostrar_grid=function(){return xajax.request({xjxfun:'mostrar_grid'},{parameters:arguments});};xajax_genera_grid=function(){return xajax.request({xjxfun:'genera_grid'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_genera_formulario_detalle=function(){return xajax.request({xjxfun:'genera_formulario_detalle'},{parameters:arguments});};xajax_actualizar_grid=function(){return xajax.request({xjxfun:'actualizar_grid'},{parameters:arguments});};xajax_total_grid=function(){return xajax.request({xjxfun:'total_grid'},{parameters:arguments});};xajax_consulta=function(){return xajax.request({xjxfun:'consulta'},{parameters:arguments});};xajax_guarda_pedido=function(){return xajax.request({xjxfun:'guarda_pedido'},{parameters:arguments});};xajax_facturas_vencidas=function(){return xajax.request({xjxfun:'facturas_vencidas'},{parameters:arguments});};xajax_pedf_num_preimp=function(){return xajax.request({xjxfun:'pedf_num_preimp'},{parameters:arguments});};xajax_secuencial_pedido=function(){return xajax.request({xjxfun:'secuencial_pedido'},{parameters:arguments});};xajax_cero_mas=function(){return xajax.request({xjxfun:'cero_mas'},{parameters:arguments});};xajax_anularPedido=function(){return xajax.request({xjxfun:'anularPedido'},{parameters:arguments});};xajax_fecha_informix=function(){return xajax.request({xjxfun:'fecha_informix'},{parameters:arguments});};xajax_fecha_mysql=function(){return xajax.request({xjxfun:'fecha_mysql'},{parameters:arguments});};xajax_cambiarFormatoFecha=function(){return xajax.request({xjxfun:'cambiarFormatoFecha'},{parameters:arguments});};xajax_sumar_dias=function(){return xajax.request({xjxfun:'sumar_dias'},{parameters:arguments});};xajax_restaFechas=function(){return xajax.request({xjxfun:'restaFechas'},{parameters:arguments});};xajax_actualiza_grid=function(){return xajax.request({xjxfun:'actualiza_grid'},{parameters:arguments});};xajax_anio_fecha_abierto=function(){return xajax.request({xjxfun:'anio_fecha_abierto'},{parameters:arguments});};xajax_guardarCheck=function(){return xajax.request({xjxfun:'guardarCheck'},{parameters:arguments});};xajax_genera_busqueda_cliente_consumidor=function(){return xajax.request({xjxfun:'genera_busqueda_cliente_consumidor'},{parameters:arguments});};xajax_formulario_orden_compra=function(){return xajax.request({xjxfun:'formulario_orden_compra'},{parameters:arguments});};xajax_agregar_items_xml=function(){return xajax.request({xjxfun:'agregar_items_xml'},{parameters:arguments});};xajax_valida_producto=function(){return xajax.request({xjxfun:'valida_producto'},{parameters:arguments});};xajax_valida_producto_edit=function(){return xajax.request({xjxfun:'valida_producto_edit'},{parameters:arguments});};xajax_editar_pedido=function(){return xajax.request({xjxfun:'editar_pedido'},{parameters:arguments});};xajax_guardar_edicion=function(){return xajax.request({xjxfun:'guardar_edicion'},{parameters:arguments});};xajax_eliminar_prod=function(){return xajax.request({xjxfun:'eliminar_prod'},{parameters:arguments});};xajax_buscar_productos=function(){return xajax.request({xjxfun:'buscar_productos'},{parameters:arguments});};xajax_ingresar_prod=function(){return xajax.request({xjxfun:'ingresar_prod'},{parameters:arguments});};xajax_detalle_facturas=function(){return xajax.request({xjxfun:'detalle_facturas'},{parameters:arguments});};xajax_form_guia=function(){return xajax.request({xjxfun:'form_guia'},{parameters:arguments});};xajax_reporte_ride=function(){return xajax.request({xjxfun:'reporte_ride'},{parameters:arguments});};xajax_genera_detalle=function(){return xajax.request({xjxfun:'genera_detalle'},{parameters:arguments});};xajax_buscar_clientes=function(){return xajax.request({xjxfun:'buscar_clientes'},{parameters:arguments});};xajax_consulta_remesas=function(){return xajax.request({xjxfun:'consulta_remesas'},{parameters:arguments});};xajax_consulta_facturas=function(){return xajax.request({xjxfun:'consulta_facturas'},{parameters:arguments});};xajax_detalle_pedido=function(){return xajax.request({xjxfun:'detalle_pedido'},{parameters:arguments});};xajax_detalle_factura=function(){return xajax.request({xjxfun:'detalle_factura'},{parameters:arguments});};xajax_finalizarPedido=function(){return xajax.request({xjxfun:'finalizarPedido'},{parameters:arguments});};xajax_agregar_items_excel=function(){return xajax.request({xjxfun:'agregar_items_excel'},{parameters:arguments});};xajax_proformas=function(){return xajax.request({xjxfun:'proformas'},{parameters:arguments});};xajax_agrega_modifica_grid_proforma=function(){return xajax.request({xjxfun:'agrega_modifica_grid_proforma'},{parameters:arguments});};xajax_carga_pedidos=function(){return xajax.request({xjxfun:'carga_pedidos'},{parameters:arguments});};xajax_procesa_pedidos=function(){return xajax.request({xjxfun:'procesa_pedidos'},{parameters:arguments});};xajax_genera_pedido=function(){return xajax.request({xjxfun:'genera_pedido'},{parameters:arguments});};xajax_guardar_cliente=function(){return xajax.request({xjxfun:'guardar_cliente'},{parameters:arguments});};xajax_cargar_lista_dire=function(){return xajax.request({xjxfun:'cargar_lista_dire'},{parameters:arguments});};xajax_formato_pedido=function(){return xajax.request({xjxfun:'formato_pedido'},{parameters:arguments});};xajax_imprime_lote_pedidos=function(){return xajax.request({xjxfun:'imprime_lote_pedidos'},{parameters:arguments});};xajax_varificar_documentos_vencidos=function(){return xajax.request({xjxfun:'varificar_documentos_vencidos'},{parameters:arguments});};xajax_autorizaPedido=function(){return xajax.request({xjxfun:'autorizaPedido'},{parameters:arguments});};xajax_aurorizaPedidoPedf=function(){return xajax.request({xjxfun:'aurorizaPedidoPedf'},{parameters:arguments});};xajax_recargar_ciudad=function(){return xajax.request({xjxfun:'recargar_ciudad'},{parameters:arguments});};xajax_detalle_productos_facturas=function(){return xajax.request({xjxfun:'detalle_productos_facturas'},{parameters:arguments});};