...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_ventas_cliente=function(){return xajax.request({xjxfun:'genera_formulario_ventas_cliente'},{parameters:arguments});};xajax_reporte_ventas_cliente=function(){return xajax.request({xjxfun:'reporte_ventas_cliente'},{parameters:arguments});};xajax_reporte_general=function(){return xajax.request({xjxfun:'reporte_general'},{parameters:arguments});};xajax_vendedor=function(){return xajax.request({xjxfun:'vendedor'},{parameters:arguments});};xajax_producto=function(){return xajax.request({xjxfun:'producto'},{parameters:arguments});};xajax_producto_vendedor=function(){return xajax.request({xjxfun:'producto_vendedor'},{parameters:arguments});};xajax_cliente=function(){return xajax.request({xjxfun:'cliente'},{parameters:arguments});};xajax_cliente_vendedor=function(){return xajax.request({xjxfun:'cliente_vendedor'},{parameters:arguments});};xajax_cliente_producto=function(){return xajax.request({xjxfun:'cliente_producto'},{parameters:arguments});};xajax_cliente_producto_vendedor=function(){return xajax.request({xjxfun:'cliente_producto_vendedor'},{parameters:arguments});};xajax_cargar_arbol=function(){return xajax.request({xjxfun:'cargar_arbol'},{parameters:arguments});};