...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_eliminar=function(){return xajax.request({xjxfun:'eliminar'},{parameters:arguments});};xajax_f_arma_codigo=function(){return xajax.request({xjxfun:'f_arma_codigo'},{parameters:arguments});};xajax_f_cargar_datos=function(){return xajax.request({xjxfun:'f_cargar_datos'},{parameters:arguments});};xajax_f_filtro_subgrupo=function(){return xajax.request({xjxfun:'f_filtro_subgrupo'},{parameters:arguments});};xajax_grabarDetalle=function(){return xajax.request({xjxfun:'grabarDetalle'},{parameters:arguments});};xajax_cargarDatosCuentas=function(){return xajax.request({xjxfun:'cargarDatosCuentas'},{parameters:arguments});};xajax_eliminar_cta_gast=function(){return xajax.request({xjxfun:'eliminar_cta_gast'},{parameters:arguments});};xajax_guardarResponsables=function(){return xajax.request({xjxfun:'guardarResponsables'},{parameters:arguments});};xajax_cargarDatosResponsables=function(){return xajax.request({xjxfun:'cargarDatosResponsables'},{parameters:arguments});};xajax_eliminar_responsables=function(){return xajax.request({xjxfun:'eliminar_responsables'},{parameters:arguments});};xajax_cargarDatosMantenimiento=function(){return xajax.request({xjxfun:'cargarDatosMantenimiento'},{parameters:arguments});};xajax_guardarMantenimiento=function(){return xajax.request({xjxfun:'guardarMantenimiento'},{parameters:arguments});};xajax_eliminar_mantenimineto=function(){return xajax.request({xjxfun:'eliminar_mantenimineto'},{parameters:arguments});};xajax_guardarOtros=function(){return xajax.request({xjxfun:'guardarOtros'},{parameters:arguments});};xajax_cargarDatosOtros=function(){return xajax.request({xjxfun:'cargarDatosOtros'},{parameters:arguments});};xajax_editar_otros_detalles=function(){return xajax.request({xjxfun:'editar_otros_detalles'},{parameters:arguments});};xajax_eliminar_otros_detalles=function(){return xajax.request({xjxfun:'eliminar_otros_detalles'},{parameters:arguments});};xajax_lista_reporte_index=function(){return xajax.request({xjxfun:'lista_reporte_index'},{parameters:arguments});};xajax_nuevoDetalle=function(){return xajax.request({xjxfun:'nuevoDetalle'},{parameters:arguments});};xajax_nuevoResponsable=function(){return xajax.request({xjxfun:'nuevoResponsable'},{parameters:arguments});};xajax_nuevoAseguradoras=function(){return xajax.request({xjxfun:'nuevoAseguradoras'},{parameters:arguments});};xajax_nuevoMantenimiento=function(){return xajax.request({xjxfun:'nuevoMantenimiento'},{parameters:arguments});};xajax_validar_cuentas=function(){return xajax.request({xjxfun:'validar_cuentas'},{parameters:arguments});};xajax_validar_ccostos=function(){return xajax.request({xjxfun:'validar_ccostos'},{parameters:arguments});};xajax_cargarDatosPartes=function(){return xajax.request({xjxfun:'cargarDatosPartes'},{parameters:arguments});};xajax_grabarDetallePartes=function(){return xajax.request({xjxfun:'grabarDetallePartes'},{parameters:arguments});};xajax_eliminarDetallesPartes=function(){return xajax.request({xjxfun:'eliminarDetallesPartes'},{parameters:arguments});};xajax_f_tipoDepreciacion=function(){return xajax.request({xjxfun:'f_tipoDepreciacion'},{parameters:arguments});};xajax_imprime_ficha=function(){return xajax.request({xjxfun:'imprime_ficha'},{parameters:arguments});};xajax_form_empleados=function(){return xajax.request({xjxfun:'form_empleados'},{parameters:arguments});};