...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_cliente=function(){return xajax.request({xjxfun:'genera_formulario_cliente'},{parameters:arguments});};xajax_calculaCapacidadPago=function(){return xajax.request({xjxfun:'calculaCapacidadPago'},{parameters:arguments});};xajax_generarTablaAmortizacion=function(){return xajax.request({xjxfun:'generarTablaAmortizacion'},{parameters:arguments});};xajax_seleccionaItem=function(){return xajax.request({xjxfun:'seleccionaItem'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_aprobarCredito=function(){return xajax.request({xjxfun:'aprobarCredito'},{parameters:arguments});};xajax_rechazaCredito=function(){return xajax.request({xjxfun:'rechazaCredito'},{parameters:arguments});};xajax_detalle=function(){return xajax.request({xjxfun:'detalle'},{parameters:arguments});};