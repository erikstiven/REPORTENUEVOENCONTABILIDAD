...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_formato=function(){return xajax.request({xjxfun:'formato'},{parameters:arguments});};xajax_verificaCondicion=function(){return xajax.request({xjxfun:'verificaCondicion'},{parameters:arguments});};xajax_procesarProd=function(){return xajax.request({xjxfun:'procesarProd'},{parameters:arguments});};xajax_guardarProd=function(){return xajax.request({xjxfun:'guardarProd'},{parameters:arguments});};xajax_genera_formulario_pedido_=function(){return xajax.request({xjxfun:'genera_formulario_pedido_'},{parameters:arguments});};xajax_consultar_=function(){return xajax.request({xjxfun:'consultar_'},{parameters:arguments});};xajax_verificaCondicion_=function(){return xajax.request({xjxfun:'verificaCondicion_'},{parameters:arguments});};xajax_guardarProd_=function(){return xajax.request({xjxfun:'guardarProd_'},{parameters:arguments});};xajax_marcarServicio=function(){return xajax.request({xjxfun:'marcarServicio'},{parameters:arguments});};