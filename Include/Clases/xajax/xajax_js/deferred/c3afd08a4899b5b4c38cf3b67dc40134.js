...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_arbol_menu=function(){return xajax.request({xjxfun:'genera_arbol_menu'},{parameters:arguments});};xajax_genera_formulario_menu=function(){return xajax.request({xjxfun:'genera_formulario_menu'},{parameters:arguments});};xajax_guarda_menu=function(){return xajax.request({xjxfun:'guarda_menu'},{parameters:arguments});};xajax_perfil=function(){return xajax.request({xjxfun:'perfil'},{parameters:arguments});};xajax_genera_tabla=function(){return xajax.request({xjxfun:'genera_tabla'},{parameters:arguments});};xajax_genera_formulario_tabla=function(){return xajax.request({xjxfun:'genera_formulario_tabla'},{parameters:arguments});};xajax_guarda_tabla=function(){return xajax.request({xjxfun:'guarda_tabla'},{parameters:arguments});};xajax_genera_tabla_definiciones=function(){return xajax.request({xjxfun:'genera_tabla_definiciones'},{parameters:arguments});};xajax_modifica_tabla_definiciones=function(){return xajax.request({xjxfun:'modifica_tabla_definiciones'},{parameters:arguments});};