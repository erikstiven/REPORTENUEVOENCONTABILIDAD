...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_formato=function(){return xajax.request({xjxfun:'formato'},{parameters:arguments});};xajax_reporte_kardex=function(){return xajax.request({xjxfun:'reporte_kardex'},{parameters:arguments});};xajax_verDetalleMovimiento=function(){return xajax.request({xjxfun:'verDetalleMovimiento'},{parameters:arguments});};xajax_aprobar=function(){return xajax.request({xjxfun:'aprobar'},{parameters:arguments});};xajax_reporte_adjunto=function(){return xajax.request({xjxfun:'reporte_adjunto'},{parameters:arguments});};xajax_guardarAdjuntos=function(){return xajax.request({xjxfun:'guardarAdjuntos'},{parameters:arguments});};xajax_consultarAdjuntos=function(){return xajax.request({xjxfun:'consultarAdjuntos'},{parameters:arguments});};xajax_agrega_modifica_gridAdj=function(){return xajax.request({xjxfun:'agrega_modifica_gridAdj'},{parameters:arguments});};xajax_reporte_orden_compra_oc=function(){return xajax.request({xjxfun:'reporte_orden_compra_oc'},{parameters:arguments});};