...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_cliente=function(){return xajax.request({xjxfun:'genera_formulario_cliente'},{parameters:arguments});};xajax_servicios_contrato=function(){return xajax.request({xjxfun:'servicios_contrato'},{parameters:arguments});};xajax_vistaPrevia_1=function(){return xajax.request({xjxfun:'vistaPrevia_1'},{parameters:arguments});};xajax_anular=function(){return xajax.request({xjxfun:'anular'},{parameters:arguments});};