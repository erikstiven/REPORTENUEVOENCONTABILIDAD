...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_cargar_cod_depar=function(){return xajax.request({xjxfun:'cargar_cod_depar'},{parameters:arguments});};xajax_cargar_check=function(){return xajax.request({xjxfun:'cargar_check'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_valida=function(){return xajax.request({xjxfun:'valida'},{parameters:arguments});};xajax_cargar_proyectos=function(){return xajax.request({xjxfun:'cargar_proyectos'},{parameters:arguments});};xajax_cargar_ciudad=function(){return xajax.request({xjxfun:'cargar_ciudad'},{parameters:arguments});};xajax_cargar_nro_patronal=function(){return xajax.request({xjxfun:'cargar_nro_patronal'},{parameters:arguments});};xajax_cargar_departamento=function(){return xajax.request({xjxfun:'cargar_departamento'},{parameters:arguments});};xajax_rubros=function(){return xajax.request({xjxfun:'rubros'},{parameters:arguments});};xajax_rubros_sucursal=function(){return xajax.request({xjxfun:'rubros_sucursal'},{parameters:arguments});};xajax_guardar_rubr=function(){return xajax.request({xjxfun:'guardar_rubr'},{parameters:arguments});};xajax_cargar_datos_rubro=function(){return xajax.request({xjxfun:'cargar_datos_rubro'},{parameters:arguments});};xajax_costo=function(){return xajax.request({xjxfun:'costo'},{parameters:arguments});};xajax_costo_sucursal=function(){return xajax.request({xjxfun:'costo_sucursal'},{parameters:arguments});};xajax_cargar_datos_costo=function(){return xajax.request({xjxfun:'cargar_datos_costo'},{parameters:arguments});};xajax_guardar_costo=function(){return xajax.request({xjxfun:'guardar_costo'},{parameters:arguments});};