...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_agrega_modifica_grid_update=function(){return xajax.request({xjxfun:'agrega_modifica_grid_update'},{parameters:arguments});};xajax_total_grid_update=function(){return xajax.request({xjxfun:'total_grid_update'},{parameters:arguments});};xajax_total_grid=function(){return xajax.request({xjxfun:'total_grid'},{parameters:arguments});};xajax_mostrar_grid=function(){return xajax.request({xjxfun:'mostrar_grid'},{parameters:arguments});};xajax_mostrar_grid_ret=function(){return xajax.request({xjxfun:'mostrar_grid_ret'},{parameters:arguments});};xajax_cancelar_pedido=function(){return xajax.request({xjxfun:'cancelar_pedido'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_actualiza_grid=function(){return xajax.request({xjxfun:'actualiza_grid'},{parameters:arguments});};xajax_guarda_pedido=function(){return xajax.request({xjxfun:'guarda_pedido'},{parameters:arguments});};xajax_cargar_grid=function(){return xajax.request({xjxfun:'cargar_grid'},{parameters:arguments});};xajax_secuencial_pedido=function(){return xajax.request({xjxfun:'secuencial_pedido'},{parameters:arguments});};xajax_cero_mas=function(){return xajax.request({xjxfun:'cero_mas'},{parameters:arguments});};xajax_genera_formulario_cliente=function(){return xajax.request({xjxfun:'genera_formulario_cliente'},{parameters:arguments});};xajax_guardar_cliente=function(){return xajax.request({xjxfun:'guardar_cliente'},{parameters:arguments});};xajax_control_tran=function(){return xajax.request({xjxfun:'control_tran'},{parameters:arguments});};xajax_lista_factura=function(){return xajax.request({xjxfun:'lista_factura'},{parameters:arguments});};xajax_cargar_factura=function(){return xajax.request({xjxfun:'cargar_factura'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_cargar_ord_compra=function(){return xajax.request({xjxfun:'cargar_ord_compra'},{parameters:arguments});};xajax_cargar_ord_compra_respaldo=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo'},{parameters:arguments});};xajax_modal_cargar_archivo=function(){return xajax.request({xjxfun:'modal_cargar_archivo'},{parameters:arguments});};xajax_cargar_arbol=function(){return xajax.request({xjxfun:'cargar_arbol'},{parameters:arguments});};xajax_abrir_modal_prod_filtro=function(){return xajax.request({xjxfun:'abrir_modal_prod_filtro'},{parameters:arguments});};xajax_procesar_informacion_filtro=function(){return xajax.request({xjxfun:'procesar_informacion_filtro'},{parameters:arguments});};xajax_abrir_modal_distribucion=function(){return xajax.request({xjxfun:'abrir_modal_distribucion'},{parameters:arguments});};xajax_validar_cuenta_contable=function(){return xajax.request({xjxfun:'validar_cuenta_contable'},{parameters:arguments});};xajax_validar_centro_costos=function(){return xajax.request({xjxfun:'validar_centro_costos'},{parameters:arguments});};xajax_calcular_valor_porcentaje=function(){return xajax.request({xjxfun:'calcular_valor_porcentaje'},{parameters:arguments});};xajax_calcular_totales_distri=function(){return xajax.request({xjxfun:'calcular_totales_distri'},{parameters:arguments});};xajax_agregar_distribucion=function(){return xajax.request({xjxfun:'agregar_distribucion'},{parameters:arguments});};