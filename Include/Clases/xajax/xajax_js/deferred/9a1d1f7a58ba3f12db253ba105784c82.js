...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_linea=function(){return xajax.request({xjxfun:'linea'},{parameters:arguments});};xajax_guardar_linea=function(){return xajax.request({xjxfun:'guardar_linea'},{parameters:arguments});};xajax_consultar_linea=function(){return xajax.request({xjxfun:'consultar_linea'},{parameters:arguments});};xajax_eliminar_linea=function(){return xajax.request({xjxfun:'eliminar_linea'},{parameters:arguments});};xajax_grupo=function(){return xajax.request({xjxfun:'grupo'},{parameters:arguments});};xajax_guardar_grupo=function(){return xajax.request({xjxfun:'guardar_grupo'},{parameters:arguments});};xajax_consultar_grupo=function(){return xajax.request({xjxfun:'consultar_grupo'},{parameters:arguments});};xajax_eliminar_grupo=function(){return xajax.request({xjxfun:'eliminar_grupo'},{parameters:arguments});};xajax_categoria=function(){return xajax.request({xjxfun:'categoria'},{parameters:arguments});};xajax_guardar_categoria=function(){return xajax.request({xjxfun:'guardar_categoria'},{parameters:arguments});};xajax_consultar_categoria=function(){return xajax.request({xjxfun:'consultar_categoria'},{parameters:arguments});};xajax_eliminar_categoria=function(){return xajax.request({xjxfun:'eliminar_categoria'},{parameters:arguments});};xajax_marca=function(){return xajax.request({xjxfun:'marca'},{parameters:arguments});};xajax_guardar_marca=function(){return xajax.request({xjxfun:'guardar_marca'},{parameters:arguments});};xajax_consultar_marca=function(){return xajax.request({xjxfun:'consultar_marca'},{parameters:arguments});};xajax_eliminar_marca=function(){return xajax.request({xjxfun:'eliminar_marca'},{parameters:arguments});};xajax_cargar_arbol=function(){return xajax.request({xjxfun:'cargar_arbol'},{parameters:arguments});};