...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_cargarTipo=function(){return xajax.request({xjxfun:'cargarTipo'},{parameters:arguments});};