...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};xajax_lista_proveedores=function(){return xajax.request({xjxfun:'lista_proveedores'},{parameters:arguments});};xajax_lista_transacciones=function(){return xajax.request({xjxfun:'lista_transacciones'},{parameters:arguments});};xajax_lista_vendedores=function(){return xajax.request({xjxfun:'lista_vendedores'},{parameters:arguments});};xajax_lista_cobradores=function(){return xajax.request({xjxfun:'lista_cobradores'},{parameters:arguments});};xajax_select_tran=function(){return xajax.request({xjxfun:'select_tran'},{parameters:arguments});};xajax_asigna_chek=function(){return xajax.request({xjxfun:'asigna_chek'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};