...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_seleccionarTran=function(){return xajax.request({xjxfun:'seleccionarTran'},{parameters:arguments});};xajax_guardar_tran=function(){return xajax.request({xjxfun:'guardar_tran'},{parameters:arguments});};xajax_update_tran_frame=function(){return xajax.request({xjxfun:'update_tran_frame'},{parameters:arguments});};xajax_agregarEntidad=function(){return xajax.request({xjxfun:'agregarEntidad'},{parameters:arguments});};xajax_f_filtro_grupo=function(){return xajax.request({xjxfun:'f_filtro_grupo'},{parameters:arguments});};xajax_f_filtro_categoria=function(){return xajax.request({xjxfun:'f_filtro_categoria'},{parameters:arguments});};xajax_f_filtro_marca=function(){return xajax.request({xjxfun:'f_filtro_marca'},{parameters:arguments});};