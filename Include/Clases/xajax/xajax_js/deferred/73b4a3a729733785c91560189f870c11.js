...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_modificar=function(){return xajax.request({xjxfun:'modificar'},{parameters:arguments});};xajax_eliminar=function(){return xajax.request({xjxfun:'eliminar'},{parameters:arguments});};xajax_genera_formulario_modifica_detalle=function(){return xajax.request({xjxfun:'genera_formulario_modifica_detalle'},{parameters:arguments});};xajax_transferir=function(){return xajax.request({xjxfun:'transferir'},{parameters:arguments});};xajax_cerrar_pedido=function(){return xajax.request({xjxfun:'cerrar_pedido'},{parameters:arguments});};xajax_vista_previa=function(){return xajax.request({xjxfun:'vista_previa'},{parameters:arguments});};xajax_cargar_pedido=function(){return xajax.request({xjxfun:'cargar_pedido'},{parameters:arguments});};xajax_cargar_tran=function(){return xajax.request({xjxfun:'cargar_tran'},{parameters:arguments});};xajax_producto_serie=function(){return xajax.request({xjxfun:'producto_serie'},{parameters:arguments});};xajax_procesar_serie=function(){return xajax.request({xjxfun:'procesar_serie'},{parameters:arguments});};xajax_mostrar_grid=function(){return xajax.request({xjxfun:'mostrar_grid'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_lista_requi=function(){return xajax.request({xjxfun:'lista_requi'},{parameters:arguments});};xajax_requisicion_det=function(){return xajax.request({xjxfun:'requisicion_det'},{parameters:arguments});};xajax_baja_req_masivo=function(){return xajax.request({xjxfun:'baja_req_masivo'},{parameters:arguments});};xajax_cargarTransportista=function(){return xajax.request({xjxfun:'cargarTransportista'},{parameters:arguments});};xajax_agregar_marca_textil=function(){return xajax.request({xjxfun:'agregar_marca_textil'},{parameters:arguments});};xajax_ver_campos_remision=function(){return xajax.request({xjxfun:'ver_campos_remision'},{parameters:arguments});};xajax_modal_cargar_archivo=function(){return xajax.request({xjxfun:'modal_cargar_archivo'},{parameters:arguments});};xajax_cargar_ord_compra_respaldo=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo'},{parameters:arguments});};xajax_consultar_archivo=function(){return xajax.request({xjxfun:'consultar_archivo'},{parameters:arguments});};xajax_cargar_ord_compra=function(){return xajax.request({xjxfun:'cargar_ord_compra'},{parameters:arguments});};xajax_cargar_transp=function(){return xajax.request({xjxfun:'cargar_transp'},{parameters:arguments});};