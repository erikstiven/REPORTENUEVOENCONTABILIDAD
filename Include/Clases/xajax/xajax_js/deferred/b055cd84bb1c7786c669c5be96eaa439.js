...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_cod_ret_b=function(){return xajax.request({xjxfun:'cod_ret_b'},{parameters:arguments});};xajax_selectTret=function(){return xajax.request({xjxfun:'selectTret'},{parameters:arguments});};