...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_guarda_pedido=function(){return xajax.request({xjxfun:'guarda_pedido'},{parameters:arguments});};xajax_reporte_precios=function(){return xajax.request({xjxfun:'reporte_precios'},{parameters:arguments});};xajax_cambiar_empresa=function(){return xajax.request({xjxfun:'cambiar_empresa'},{parameters:arguments});};xajax_seleccionar_bodegas=function(){return xajax.request({xjxfun:'seleccionar_bodegas'},{parameters:arguments});};