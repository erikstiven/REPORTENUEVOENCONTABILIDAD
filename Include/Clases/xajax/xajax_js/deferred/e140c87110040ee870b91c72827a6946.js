...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_editarFact=function(){return xajax.request({xjxfun:'editarFact'},{parameters:arguments});};xajax_editarNdeb=function(){return xajax.request({xjxfun:'editarNdeb'},{parameters:arguments});};xajax_obtenerSiglaDire=function(){return xajax.request({xjxfun:'obtenerSiglaDire'},{parameters:arguments});};