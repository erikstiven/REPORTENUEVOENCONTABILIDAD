...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_agrega_modifica_grid_update=function(){return xajax.request({xjxfun:'agrega_modifica_grid_update'},{parameters:arguments});};xajax_total_grid_update=function(){return xajax.request({xjxfun:'total_grid_update'},{parameters:arguments});};xajax_total_grid=function(){return xajax.request({xjxfun:'total_grid'},{parameters:arguments});};xajax_mostrar_grid=function(){return xajax.request({xjxfun:'mostrar_grid'},{parameters:arguments});};xajax_mostrar_grid_ret=function(){return xajax.request({xjxfun:'mostrar_grid_ret'},{parameters:arguments});};xajax_cancelar_pedido=function(){return xajax.request({xjxfun:'cancelar_pedido'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_actualiza_grid=function(){return xajax.request({xjxfun:'actualiza_grid'},{parameters:arguments});};xajax_guarda_pedido=function(){return xajax.request({xjxfun:'guarda_pedido'},{parameters:arguments});};xajax_cargar_grid=function(){return xajax.request({xjxfun:'cargar_grid'},{parameters:arguments});};xajax_secuencial_pedido=function(){return xajax.request({xjxfun:'secuencial_pedido'},{parameters:arguments});};xajax_cero_mas=function(){return xajax.request({xjxfun:'cero_mas'},{parameters:arguments});};xajax_pedido=function(){return xajax.request({xjxfun:'pedido'},{parameters:arguments});};xajax_cargar_pedido=function(){return xajax.request({xjxfun:'cargar_pedido'},{parameters:arguments});};xajax_orden_compra=function(){return xajax.request({xjxfun:'orden_compra'},{parameters:arguments});};xajax_cargar_orden_compra=function(){return xajax.request({xjxfun:'cargar_orden_compra'},{parameters:arguments});};xajax_form_orden_compra=function(){return xajax.request({xjxfun:'form_orden_compra'},{parameters:arguments});};xajax_update_pedido=function(){return xajax.request({xjxfun:'update_pedido'},{parameters:arguments});};xajax_detalle_compra=function(){return xajax.request({xjxfun:'detalle_compra'},{parameters:arguments});};xajax_cargar_productos=function(){return xajax.request({xjxfun:'cargar_productos'},{parameters:arguments});};xajax_envia_email=function(){return xajax.request({xjxfun:'envia_email'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_genera_formulario_detalle=function(){return xajax.request({xjxfun:'genera_formulario_detalle'},{parameters:arguments});};xajax_actualizar_grid=function(){return xajax.request({xjxfun:'actualizar_grid'},{parameters:arguments});};xajax_cotizacion=function(){return xajax.request({xjxfun:'cotizacion'},{parameters:arguments});};xajax_clpv_reporte=function(){return xajax.request({xjxfun:'clpv_reporte'},{parameters:arguments});};xajax_cargar_bodega=function(){return xajax.request({xjxfun:'cargar_bodega'},{parameters:arguments});};xajax_producto_inventario=function(){return xajax.request({xjxfun:'producto_inventario'},{parameters:arguments});};xajax_modificar_detalle=function(){return xajax.request({xjxfun:'modificar_detalle'},{parameters:arguments});};xajax_procesar_item=function(){return xajax.request({xjxfun:'procesar_item'},{parameters:arguments});};xajax_detalle_oc=function(){return xajax.request({xjxfun:'detalle_oc'},{parameters:arguments});};xajax_anular_oc=function(){return xajax.request({xjxfun:'anular_oc'},{parameters:arguments});};xajax_cargar_ord_compra=function(){return xajax.request({xjxfun:'cargar_ord_compra'},{parameters:arguments});};xajax_cargar_ord_compra_respaldo=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo'},{parameters:arguments});};xajax_habilita_ccos=function(){return xajax.request({xjxfun:'habilita_ccos'},{parameters:arguments});};xajax_cambioMetodoJs=function(){return xajax.request({xjxfun:'cambioMetodoJs'},{parameters:arguments});};xajax_cargar_cuentas=function(){return xajax.request({xjxfun:'cargar_cuentas'},{parameters:arguments});};xajax_cargar_arbol_partidas=function(){return xajax.request({xjxfun:'cargar_arbol_partidas'},{parameters:arguments});};xajax_modal_envio_mensajes=function(){return xajax.request({xjxfun:'modal_envio_mensajes'},{parameters:arguments});};