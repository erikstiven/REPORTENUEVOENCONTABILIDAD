...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_cargar_lista=function(){return xajax.request({xjxfun:'cargar_lista'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_cargar_lista2=function(){return xajax.request({xjxfun:'cargar_lista2'},{parameters:arguments});};xajax_consulta_resumido=function(){return xajax.request({xjxfun:'consulta_resumido'},{parameters:arguments});};