...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_agrega_modifica_grid=function(){return xajax.request({xjxfun:'agrega_modifica_grid'},{parameters:arguments});};xajax_agrega_modifica_grid_update=function(){return xajax.request({xjxfun:'agrega_modifica_grid_update'},{parameters:arguments});};xajax_total_grid_update=function(){return xajax.request({xjxfun:'total_grid_update'},{parameters:arguments});};xajax_total_grid=function(){return xajax.request({xjxfun:'total_grid'},{parameters:arguments});};xajax_total_grid1=function(){return xajax.request({xjxfun:'total_grid1'},{parameters:arguments});};xajax_mostrar_grid=function(){return xajax.request({xjxfun:'mostrar_grid'},{parameters:arguments});};xajax_mostrar_grid_ret=function(){return xajax.request({xjxfun:'mostrar_grid_ret'},{parameters:arguments});};xajax_cancelar_pedido=function(){return xajax.request({xjxfun:'cancelar_pedido'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_actualiza_grid=function(){return xajax.request({xjxfun:'actualiza_grid'},{parameters:arguments});};xajax_guarda_pedido=function(){return xajax.request({xjxfun:'guarda_pedido'},{parameters:arguments});};xajax_cargar_grid=function(){return xajax.request({xjxfun:'cargar_grid'},{parameters:arguments});};xajax_secuencial_pedido=function(){return xajax.request({xjxfun:'secuencial_pedido'},{parameters:arguments});};xajax_cero_mas=function(){return xajax.request({xjxfun:'cero_mas'},{parameters:arguments});};xajax_genera_formulario_cliente=function(){return xajax.request({xjxfun:'genera_formulario_cliente'},{parameters:arguments});};xajax_guardar_cliente=function(){return xajax.request({xjxfun:'guardar_cliente'},{parameters:arguments});};xajax_control_tran=function(){return xajax.request({xjxfun:'control_tran'},{parameters:arguments});};xajax_lista_factura=function(){return xajax.request({xjxfun:'lista_factura'},{parameters:arguments});};xajax_cargar_factura=function(){return xajax.request({xjxfun:'cargar_factura'},{parameters:arguments});};xajax_cargar_ord_compra=function(){return xajax.request({xjxfun:'cargar_ord_compra'},{parameters:arguments});};xajax_cargar_ord_compra_respaldo=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo'},{parameters:arguments});};xajax_modal_cargar_archivo=function(){return xajax.request({xjxfun:'modal_cargar_archivo'},{parameters:arguments});};xajax_reporte_entrada=function(){return xajax.request({xjxfun:'reporte_entrada'},{parameters:arguments});};