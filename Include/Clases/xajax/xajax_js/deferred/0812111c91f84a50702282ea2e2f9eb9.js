...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_cargarListaSucursal=function(){return xajax.request({xjxfun:'cargarListaSucursal'},{parameters:arguments});};xajax_cargarListaBodega=function(){return xajax.request({xjxfun:'cargarListaBodega'},{parameters:arguments});};xajax_cargarListaGrupo=function(){return xajax.request({xjxfun:'cargarListaGrupo'},{parameters:arguments});};xajax_cargarListaCategoria=function(){return xajax.request({xjxfun:'cargarListaCategoria'},{parameters:arguments});};xajax_cargarListaMarca=function(){return xajax.request({xjxfun:'cargarListaMarca'},{parameters:arguments});};xajax_modal_agregar=function(){return xajax.request({xjxfun:'modal_agregar'},{parameters:arguments});};xajax_mostrar_filtros=function(){return xajax.request({xjxfun:'mostrar_filtros'},{parameters:arguments});};xajax_armar_productos_oc=function(){return xajax.request({xjxfun:'armar_productos_oc'},{parameters:arguments});};xajax_sincronizar_dashboard=function(){return xajax.request({xjxfun:'sincronizar_dashboard'},{parameters:arguments});};xajax_actualizar_estado_punto_reorden_seleccionados=function(){return xajax.request({xjxfun:'actualizar_estado_punto_reorden_seleccionados'},{parameters:arguments});};