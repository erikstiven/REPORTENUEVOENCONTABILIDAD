...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_filtro_usuarios2=function(){return xajax.request({xjxfun:'genera_filtro_usuarios2'},{parameters:arguments});};xajax_procesa_filtro_usuarios2=function(){return xajax.request({xjxfun:'procesa_filtro_usuarios2'},{parameters:arguments});};xajax_verifica_usuario2=function(){return xajax.request({xjxfun:'verifica_usuario2'},{parameters:arguments});};xajax_procesa_filtro_usuarios2=function(){return xajax.request({xjxfun:'procesa_filtro_usuarios2'},{parameters:arguments});};xajax_genera_formulario_usuario=function(){return xajax.request({xjxfun:'genera_formulario_usuario'},{parameters:arguments});};xajax_genera_reporte_usuario=function(){return xajax.request({xjxfun:'genera_reporte_usuario'},{parameters:arguments});};xajax_guarda_formulario_usuario=function(){return xajax.request({xjxfun:'guarda_formulario_usuario'},{parameters:arguments});};xajax_genera_lista_usuario=function(){return xajax.request({xjxfun:'genera_lista_usuario'},{parameters:arguments});};xajax_modifica_usuario=function(){return xajax.request({xjxfun:'modifica_usuario'},{parameters:arguments});};xajax_cambio_clave=function(){return xajax.request({xjxfun:'cambio_clave'},{parameters:arguments});};xajax_envio_correo=function(){return xajax.request({xjxfun:'envio_correo'},{parameters:arguments});};xajax_genera_bodega=function(){return xajax.request({xjxfun:'genera_bodega'},{parameters:arguments});};xajax_cargar_empl=function(){return xajax.request({xjxfun:'cargar_empl'},{parameters:arguments});};xajax_form_importar=function(){return xajax.request({xjxfun:'form_importar'},{parameters:arguments});};xajax_cargar_usuario=function(){return xajax.request({xjxfun:'cargar_usuario'},{parameters:arguments});};xajax_guardar_importar=function(){return xajax.request({xjxfun:'guardar_importar'},{parameters:arguments});};xajax_modal_firma=function(){return xajax.request({xjxfun:'modal_firma'},{parameters:arguments});};xajax_cambio_usuarios=function(){return xajax.request({xjxfun:'cambio_usuarios'},{parameters:arguments});};xajax_parametros=function(){return xajax.request({xjxfun:'parametros'},{parameters:arguments});};xajax_parametros2=function(){return xajax.request({xjxfun:'parametros2'},{parameters:arguments});};xajax_guardar_empl=function(){return xajax.request({xjxfun:'guardar_empl'},{parameters:arguments});};xajax_guardar_vend=function(){return xajax.request({xjxfun:'guardar_vend'},{parameters:arguments});};