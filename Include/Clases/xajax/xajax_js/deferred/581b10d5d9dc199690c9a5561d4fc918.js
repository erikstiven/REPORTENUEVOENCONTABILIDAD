...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_agregar=function(){return xajax.request({xjxfun:'agregar'},{parameters:arguments});};xajax_eliminar_item=function(){return xajax.request({xjxfun:'eliminar_item'},{parameters:arguments});};xajax_constantes=function(){return xajax.request({xjxfun:'constantes'},{parameters:arguments});};