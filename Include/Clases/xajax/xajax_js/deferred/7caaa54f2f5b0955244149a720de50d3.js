...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_seleccionarTran=function(){return xajax.request({xjxfun:'seleccionarTran'},{parameters:arguments});};xajax_guardar_tran=function(){return xajax.request({xjxfun:'guardar_tran'},{parameters:arguments});};xajax_update_tran_frame=function(){return xajax.request({xjxfun:'update_tran_frame'},{parameters:arguments});};xajax_agregarEntidad=function(){return xajax.request({xjxfun:'agregarEntidad'},{parameters:arguments});};xajax_clpv_contrato=function(){return xajax.request({xjxfun:'clpv_contrato'},{parameters:arguments});};xajax_producto_inventario=function(){return xajax.request({xjxfun:'producto_inventario'},{parameters:arguments});};xajax_barrio=function(){return xajax.request({xjxfun:'barrio'},{parameters:arguments});};xajax_verificar_cuenta=function(){return xajax.request({xjxfun:'verificar_cuenta'},{parameters:arguments});};