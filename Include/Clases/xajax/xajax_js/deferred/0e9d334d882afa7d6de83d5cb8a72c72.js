...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_cargar_ord_compra_respaldo=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_borrar=function(){return xajax.request({xjxfun:'borrar'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_reimpresion=function(){return xajax.request({xjxfun:'reimpresion'},{parameters:arguments});};xajax_parametros=function(){return xajax.request({xjxfun:'parametros'},{parameters:arguments});};xajax_actualiza_finca=function(){return xajax.request({xjxfun:'actualiza_finca'},{parameters:arguments});};xajax_borrar_finca=function(){return xajax.request({xjxfun:'borrar_finca'},{parameters:arguments});};xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_clpv_reporte=function(){return xajax.request({xjxfun:'clpv_reporte'},{parameters:arguments});};xajax_cargarListaSector2=function(){return xajax.request({xjxfun:'cargarListaSector2'},{parameters:arguments});};xajax_cargarListaSeccion=function(){return xajax.request({xjxfun:'cargarListaSeccion'},{parameters:arguments});};xajax_cargarListaLote=function(){return xajax.request({xjxfun:'cargarListaLote'},{parameters:arguments});};xajax_cargarTotal=function(){return xajax.request({xjxfun:'cargarTotal'},{parameters:arguments});};xajax_reporte_ciclo=function(){return xajax.request({xjxfun:'reporte_ciclo'},{parameters:arguments});};xajax_reporte_recetas=function(){return xajax.request({xjxfun:'reporte_recetas'},{parameters:arguments});};xajax_filtro_busqueda=function(){return xajax.request({xjxfun:'filtro_busqueda'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_carga_form_me=function(){return xajax.request({xjxfun:'carga_form_me'},{parameters:arguments});};xajax_cargar_val=function(){return xajax.request({xjxfun:'cargar_val'},{parameters:arguments});};xajax_info_adicional=function(){return xajax.request({xjxfun:'info_adicional'},{parameters:arguments});};xajax_envio_correo=function(){return xajax.request({xjxfun:'envio_correo'},{parameters:arguments});};xajax_cargar_clasificacion=function(){return xajax.request({xjxfun:'cargar_clasificacion'},{parameters:arguments});};xajax_formulario_reporte=function(){return xajax.request({xjxfun:'formulario_reporte'},{parameters:arguments});};xajax_derivar=function(){return xajax.request({xjxfun:'derivar'},{parameters:arguments});};xajax_vista_asignado=function(){return xajax.request({xjxfun:'vista_asignado'},{parameters:arguments});};xajax_validar=function(){return xajax.request({xjxfun:'validar'},{parameters:arguments});};xajax_finalizar_incidencia=function(){return xajax.request({xjxfun:'finalizar_incidencia'},{parameters:arguments});};xajax_vista_finalizado=function(){return xajax.request({xjxfun:'vista_finalizado'},{parameters:arguments});};xajax_cargar_contratos=function(){return xajax.request({xjxfun:'cargar_contratos'},{parameters:arguments});};xajax_guardarContratos=function(){return xajax.request({xjxfun:'guardarContratos'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_formato_proformas=function(){return xajax.request({xjxfun:'formato_proformas'},{parameters:arguments});};xajax_modal_anular=function(){return xajax.request({xjxfun:'modal_anular'},{parameters:arguments});};xajax_anular_proformas=function(){return xajax.request({xjxfun:'anular_proformas'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};