...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_agrega_modifica_grid_dir=function(){return xajax.request({xjxfun:'agrega_modifica_grid_dir'},{parameters:arguments});};xajax_agrega_modifica_grid_dir_ori=function(){return xajax.request({xjxfun:'agrega_modifica_grid_dir_ori'},{parameters:arguments});};xajax_mostrar_grid_dir=function(){return xajax.request({xjxfun:'mostrar_grid_dir'},{parameters:arguments});};xajax_elimina_detalle_dir=function(){return xajax.request({xjxfun:'elimina_detalle_dir'},{parameters:arguments});};xajax_agrega_modifica_grid_ret=function(){return xajax.request({xjxfun:'agrega_modifica_grid_ret'},{parameters:arguments});};xajax_mostrar_grid_ret=function(){return xajax.request({xjxfun:'mostrar_grid_ret'},{parameters:arguments});};xajax_elimina_detalle_ret=function(){return xajax.request({xjxfun:'elimina_detalle_ret'},{parameters:arguments});};xajax_agrega_modifica_grid_dia=function(){return xajax.request({xjxfun:'agrega_modifica_grid_dia'},{parameters:arguments});};xajax_mostrar_grid_dia=function(){return xajax.request({xjxfun:'mostrar_grid_dia'},{parameters:arguments});};xajax_elimina_detalle_dia=function(){return xajax.request({xjxfun:'elimina_detalle_dia'},{parameters:arguments});};xajax_agrega_modifica_grid_ret=function(){return xajax.request({xjxfun:'agrega_modifica_grid_ret'},{parameters:arguments});};xajax_mostrar_grid_ret=function(){return xajax.request({xjxfun:'mostrar_grid_ret'},{parameters:arguments});};xajax_elimina_detalle_ret=function(){return xajax.request({xjxfun:'elimina_detalle_ret'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};xajax_reporte_facturas=function(){return xajax.request({xjxfun:'reporte_facturas'},{parameters:arguments});};xajax_reporte_facturas_ret=function(){return xajax.request({xjxfun:'reporte_facturas_ret'},{parameters:arguments});};xajax_calculo=function(){return xajax.request({xjxfun:'calculo'},{parameters:arguments});};xajax_numero_ret=function(){return xajax.request({xjxfun:'numero_ret'},{parameters:arguments});};xajax_total_diario=function(){return xajax.request({xjxfun:'total_diario'},{parameters:arguments});};xajax_cargar_tot=function(){return xajax.request({xjxfun:'cargar_tot'},{parameters:arguments});};xajax_reporte_cheque=function(){return xajax.request({xjxfun:'reporte_cheque'},{parameters:arguments});};xajax_agrega_modifica_grid_dia_cheque=function(){return xajax.request({xjxfun:'agrega_modifica_grid_dia_cheque'},{parameters:arguments});};xajax_cargar_coti=function(){return xajax.request({xjxfun:'cargar_coti'},{parameters:arguments});};xajax_formulario_prestamo=function(){return xajax.request({xjxfun:'formulario_prestamo'},{parameters:arguments});};xajax_generarTablaAmortizacion=function(){return xajax.request({xjxfun:'generarTablaAmortizacion'},{parameters:arguments});};xajax_guardar_prestamo=function(){return xajax.request({xjxfun:'guardar_prestamo'},{parameters:arguments});};xajax_reporte_credito=function(){return xajax.request({xjxfun:'reporte_credito'},{parameters:arguments});};xajax_checkPrestamo=function(){return xajax.request({xjxfun:'checkPrestamo'},{parameters:arguments});};xajax_parametrosPrestamo=function(){return xajax.request({xjxfun:'parametrosPrestamo'},{parameters:arguments});};xajax_cargar_lista_tran=function(){return xajax.request({xjxfun:'cargar_lista_tran'},{parameters:arguments});};xajax_cargar_lista_subcliente=function(){return xajax.request({xjxfun:'cargar_lista_subcliente'},{parameters:arguments});};xajax_controlPeriodoIfx=function(){return xajax.request({xjxfun:'controlPeriodoIfx'},{parameters:arguments});};xajax_calculaValorRetenido=function(){return xajax.request({xjxfun:'calculaValorRetenido'},{parameters:arguments});};xajax_nomina=function(){return xajax.request({xjxfun:'nomina'},{parameters:arguments});};xajax_buscar_nomina=function(){return xajax.request({xjxfun:'buscar_nomina'},{parameters:arguments});};xajax_generar_cheques_empleados=function(){return xajax.request({xjxfun:'generar_cheques_empleados'},{parameters:arguments});};xajax_procesar_cheques_nomina=function(){return xajax.request({xjxfun:'procesar_cheques_nomina'},{parameters:arguments});};xajax_controlCheque=function(){return xajax.request({xjxfun:'controlCheque'},{parameters:arguments});};xajax_formulario_prestamo=function(){return xajax.request({xjxfun:'formulario_prestamo'},{parameters:arguments});};xajax_generarTablaAmortizacion=function(){return xajax.request({xjxfun:'generarTablaAmortizacion'},{parameters:arguments});};xajax_guardar_prestamo=function(){return xajax.request({xjxfun:'guardar_prestamo'},{parameters:arguments});};xajax_form_modificar_valor=function(){return xajax.request({xjxfun:'form_modificar_valor'},{parameters:arguments});};xajax_modificar_valor=function(){return xajax.request({xjxfun:'modificar_valor'},{parameters:arguments});};xajax_agrega_modifica_grid_dia_empl=function(){return xajax.request({xjxfun:'agrega_modifica_grid_dia_empl'},{parameters:arguments});};xajax_documento_digito=function(){return xajax.request({xjxfun:'documento_digito'},{parameters:arguments});};xajax_ftrn_tip_movi=function(){return xajax.request({xjxfun:'ftrn_tip_movi'},{parameters:arguments});};xajax_genera_pagos=function(){return xajax.request({xjxfun:'genera_pagos'},{parameters:arguments});};xajax_agrega_modifica_grid_dir_pago=function(){return xajax.request({xjxfun:'agrega_modifica_grid_dir_pago'},{parameters:arguments});};xajax_modal_cheque=function(){return xajax.request({xjxfun:'modal_cheque'},{parameters:arguments});};xajax_genera_pdf_doc1=function(){return xajax.request({xjxfun:'genera_pdf_doc1'},{parameters:arguments});};xajax_form_adjuntos=function(){return xajax.request({xjxfun:'form_adjuntos'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_pdf_doc_compras=function(){return xajax.request({xjxfun:'genera_pdf_doc_compras'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_genera_pdf_cheque=function(){return xajax.request({xjxfun:'genera_pdf_cheque'},{parameters:arguments});};xajax_cargarModalOc=function(){return xajax.request({xjxfun:'cargarModalOc'},{parameters:arguments});};xajax_modal_adjuntos=function(){return xajax.request({xjxfun:'modal_adjuntos'},{parameters:arguments});};xajax_guardarAdjuntos=function(){return xajax.request({xjxfun:'guardarAdjuntos'},{parameters:arguments});};xajax_verAdj=function(){return xajax.request({xjxfun:'verAdj'},{parameters:arguments});};xajax_abre_modal_canje=function(){return xajax.request({xjxfun:'abre_modal_canje'},{parameters:arguments});};xajax_procesar_letras=function(){return xajax.request({xjxfun:'procesar_letras'},{parameters:arguments});};xajax_agregar_canje_letra=function(){return xajax.request({xjxfun:'agregar_canje_letra'},{parameters:arguments});};