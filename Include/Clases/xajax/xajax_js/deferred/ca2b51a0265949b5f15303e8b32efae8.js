...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_reporte=function(){return xajax.request({xjxfun:'genera_formulario_reporte'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_cargar_sucu=function(){return xajax.request({xjxfun:'cargar_sucu'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_pedido_det=function(){return xajax.request({xjxfun:'pedido_det'},{parameters:arguments});};xajax_eliminar=function(){return xajax.request({xjxfun:'eliminar'},{parameters:arguments});};xajax_cargar_txt=function(){return xajax.request({xjxfun:'cargar_txt'},{parameters:arguments});};xajax_guardar_clpv=function(){return xajax.request({xjxfun:'guardar_clpv'},{parameters:arguments});};xajax_generar=function(){return xajax.request({xjxfun:'generar'},{parameters:arguments});};xajax_clave_acceso=function(){return xajax.request({xjxfun:'clave_acceso'},{parameters:arguments});};xajax_guardar_gasto=function(){return xajax.request({xjxfun:'guardar_gasto'},{parameters:arguments});};xajax_cargar_planilla=function(){return xajax.request({xjxfun:'cargar_planilla'},{parameters:arguments});};xajax_guardar_caja_chica=function(){return xajax.request({xjxfun:'guardar_caja_chica'},{parameters:arguments});};xajax_generar_almacen=function(){return xajax.request({xjxfun:'generar_almacen'},{parameters:arguments});};xajax_guardar_almacen=function(){return xajax.request({xjxfun:'guardar_almacen'},{parameters:arguments});};xajax_retencion_auto=function(){return xajax.request({xjxfun:'retencion_auto'},{parameters:arguments});};xajax_calculo_ret=function(){return xajax.request({xjxfun:'calculo_ret'},{parameters:arguments});};xajax_asiento_gasto=function(){return xajax.request({xjxfun:'asiento_gasto'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_pdf_doc_compras=function(){return xajax.request({xjxfun:'genera_pdf_doc_compras'},{parameters:arguments});};