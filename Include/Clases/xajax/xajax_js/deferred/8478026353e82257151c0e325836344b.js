...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario_cliente=function(){return xajax.request({xjxfun:'genera_formulario_cliente'},{parameters:arguments});};xajax_seleccionarParametros=function(){return xajax.request({xjxfun:'seleccionarParametros'},{parameters:arguments});};xajax_guardar_parametros=function(){return xajax.request({xjxfun:'guardar_parametros'},{parameters:arguments});};xajax_update_parametros_frame=function(){return xajax.request({xjxfun:'update_parametros_frame'},{parameters:arguments});};