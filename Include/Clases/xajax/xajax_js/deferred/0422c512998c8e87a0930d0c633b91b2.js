...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_generar=function(){return xajax.request({xjxfun:'generar'},{parameters:arguments});};xajax_f_filtro_subgrupo=function(){return xajax.request({xjxfun:'f_filtro_subgrupo'},{parameters:arguments});};xajax_f_filtro_activos=function(){return xajax.request({xjxfun:'f_filtro_activos'},{parameters:arguments});};xajax_f_filtro_activos1=function(){return xajax.request({xjxfun:'f_filtro_activos1'},{parameters:arguments});};xajax_f_filtro_mes=function(){return xajax.request({xjxfun:'f_filtro_mes'},{parameters:arguments});};xajax_f_filtro_mes_fin=function(){return xajax.request({xjxfun:'f_filtro_mes_fin'},{parameters:arguments});};xajax_f_filtro_sucursal=function(){return xajax.request({xjxfun:'f_filtro_sucursal'},{parameters:arguments});};xajax_f_filtro_grupo=function(){return xajax.request({xjxfun:'f_filtro_grupo'},{parameters:arguments});};xajax_f_filtro_anio_i=function(){return xajax.request({xjxfun:'f_filtro_anio_i'},{parameters:arguments});};xajax_f_filtro_anio_f=function(){return xajax.request({xjxfun:'f_filtro_anio_f'},{parameters:arguments});};