...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_formulario=function(){return xajax.request({xjxfun:'formulario'},{parameters:arguments});};xajax_cargar_Sucursal=function(){return xajax.request({xjxfun:'cargar_Sucursal'},{parameters:arguments});};xajax_buscar_cliente=function(){return xajax.request({xjxfun:'buscar_cliente'},{parameters:arguments});};xajax_genera_busqueda_cliente=function(){return xajax.request({xjxfun:'genera_busqueda_cliente'},{parameters:arguments});};xajax_cargar_proveedor=function(){return xajax.request({xjxfun:'cargar_proveedor'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_muestra_detalle=function(){return xajax.request({xjxfun:'muestra_detalle'},{parameters:arguments});};xajax_quita_prove=function(){return xajax.request({xjxfun:'quita_prove'},{parameters:arguments});};xajax_quita_cuenta=function(){return xajax.request({xjxfun:'quita_cuenta'},{parameters:arguments});};xajax_ordena=function(){return xajax.request({xjxfun:'ordena'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_modificaFecha=function(){return xajax.request({xjxfun:'modificaFecha'},{parameters:arguments});};xajax_updateFechas=function(){return xajax.request({xjxfun:'updateFechas'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};