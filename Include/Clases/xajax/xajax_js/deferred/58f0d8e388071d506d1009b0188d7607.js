...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_guardarSector=function(){return xajax.request({xjxfun:'guardarSector'},{parameters:arguments});};xajax_editarSector=function(){return xajax.request({xjxfun:'editarSector'},{parameters:arguments});};xajax_updateSector=function(){return xajax.request({xjxfun:'updateSector'},{parameters:arguments});};xajax_cargar_lista_sector=function(){return xajax.request({xjxfun:'cargar_lista_sector'},{parameters:arguments});};xajax_guardarBarrio=function(){return xajax.request({xjxfun:'guardarBarrio'},{parameters:arguments});};xajax_editarBarrio=function(){return xajax.request({xjxfun:'editarBarrio'},{parameters:arguments});};xajax_updateBarrio=function(){return xajax.request({xjxfun:'updateBarrio'},{parameters:arguments});};xajax_cargar_lista_cantones=function(){return xajax.request({xjxfun:'cargar_lista_cantones'},{parameters:arguments});};xajax_cargar_lista_parroquia=function(){return xajax.request({xjxfun:'cargar_lista_parroquia'},{parameters:arguments});};xajax_cargar_lista_sectores=function(){return xajax.request({xjxfun:'cargar_lista_sectores'},{parameters:arguments});};xajax_conectado=function(){return xajax.request({xjxfun:'conectado'},{parameters:arguments});};