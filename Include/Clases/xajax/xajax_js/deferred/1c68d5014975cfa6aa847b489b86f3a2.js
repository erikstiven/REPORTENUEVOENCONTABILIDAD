...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_cargar_ord_compra_respaldo=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo'},{parameters:arguments});};xajax_cargar_ord_compra_respaldo2=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo2'},{parameters:arguments});};xajax_cargar_ord_compra_respaldo3=function(){return xajax.request({xjxfun:'cargar_ord_compra_respaldo3'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_borrar=function(){return xajax.request({xjxfun:'borrar'},{parameters:arguments});};xajax_borrar2=function(){return xajax.request({xjxfun:'borrar2'},{parameters:arguments});};xajax_borrar3=function(){return xajax.request({xjxfun:'borrar3'},{parameters:arguments});};xajax_parametros=function(){return xajax.request({xjxfun:'parametros'},{parameters:arguments});};xajax_actualiza_finca=function(){return xajax.request({xjxfun:'actualiza_finca'},{parameters:arguments});};xajax_borrar_finca=function(){return xajax.request({xjxfun:'borrar_finca'},{parameters:arguments});};xajax_genera_formulario_pedido=function(){return xajax.request({xjxfun:'genera_formulario_pedido'},{parameters:arguments});};xajax_genera_formulario_linea=function(){return xajax.request({xjxfun:'genera_formulario_linea'},{parameters:arguments});};xajax_genera_formulario_carga=function(){return xajax.request({xjxfun:'genera_formulario_carga'},{parameters:arguments});};xajax_cargar_fase=function(){return xajax.request({xjxfun:'cargar_fase'},{parameters:arguments});};xajax_cargarListaSeccion=function(){return xajax.request({xjxfun:'cargarListaSeccion'},{parameters:arguments});};xajax_clpv_reporte=function(){return xajax.request({xjxfun:'clpv_reporte'},{parameters:arguments});};xajax_cargar_bloq=function(){return xajax.request({xjxfun:'cargar_bloq'},{parameters:arguments});};xajax_cargar_datos=function(){return xajax.request({xjxfun:'cargar_datos'},{parameters:arguments});};xajax_cargarListaSeccion=function(){return xajax.request({xjxfun:'cargarListaSeccion'},{parameters:arguments});};xajax_cargarListapbloq=function(){return xajax.request({xjxfun:'cargarListapbloq'},{parameters:arguments});};xajax_estados=function(){return xajax.request({xjxfun:'estados'},{parameters:arguments});};xajax_guardar_estados=function(){return xajax.request({xjxfun:'guardar_estados'},{parameters:arguments});};xajax_eliminar_estado=function(){return xajax.request({xjxfun:'eliminar_estado'},{parameters:arguments});};xajax_consumo_alimento=function(){return xajax.request({xjxfun:'consumo_alimento'},{parameters:arguments});};xajax_estadosA=function(){return xajax.request({xjxfun:'estadosA'},{parameters:arguments});};xajax_guardarlinea=function(){return xajax.request({xjxfun:'guardarlinea'},{parameters:arguments});};xajax_guardarcarga=function(){return xajax.request({xjxfun:'guardarcarga'},{parameters:arguments});};