...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_verDiarioContable=function(){return xajax.request({xjxfun:'verDiarioContable'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};xajax_reporte_mayor_general=function(){return xajax.request({xjxfun:'reporte_mayor_general'},{parameters:arguments});};xajax_genera_pdf_doc=function(){return xajax.request({xjxfun:'genera_pdf_doc'},{parameters:arguments});};