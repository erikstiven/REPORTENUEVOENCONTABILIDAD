...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_cambioFiltroFecha=function(){return xajax.request({xjxfun:'cambioFiltroFecha'},{parameters:arguments});};xajax_cargarMes=function(){return xajax.request({xjxfun:'cargarMes'},{parameters:arguments});};xajax_f_filtro_mes_fin=function(){return xajax.request({xjxfun:'f_filtro_mes_fin'},{parameters:arguments});};xajax_f_filtro_periodo=function(){return xajax.request({xjxfun:'f_filtro_periodo'},{parameters:arguments});};xajax_f_filtro_ejercicio=function(){return xajax.request({xjxfun:'f_filtro_ejercicio'},{parameters:arguments});};xajax_f_filtro_sucursal=function(){return xajax.request({xjxfun:'f_filtro_sucursal'},{parameters:arguments});};xajax_reporte_clientes=function(){return xajax.request({xjxfun:'reporte_clientes'},{parameters:arguments});};