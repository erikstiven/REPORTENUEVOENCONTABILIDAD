...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_consultar_factVent=function(){return xajax.request({xjxfun:'consultar_factVent'},{parameters:arguments});};xajax_consultar_notaDebi=function(){return xajax.request({xjxfun:'consultar_notaDebi'},{parameters:arguments});};xajax_consultar_notaCred=function(){return xajax.request({xjxfun:'consultar_notaCred'},{parameters:arguments});};xajax_consultar_guiaRemi=function(){return xajax.request({xjxfun:'consultar_guiaRemi'},{parameters:arguments});};xajax_consultar_reteGast=function(){return xajax.request({xjxfun:'consultar_reteGast'},{parameters:arguments});};xajax_consultar_reteInve=function(){return xajax.request({xjxfun:'consultar_reteInve'},{parameters:arguments});};xajax_consultar_factExpor=function(){return xajax.request({xjxfun:'consultar_factExpor'},{parameters:arguments});};xajax_consultar_factFlor=function(){return xajax.request({xjxfun:'consultar_factFlor'},{parameters:arguments});};xajax_consultar_factFlorExpor=function(){return xajax.request({xjxfun:'consultar_factFlorExpor'},{parameters:arguments});};xajax_consultar_guiaRemiFlor=function(){return xajax.request({xjxfun:'consultar_guiaRemiFlor'},{parameters:arguments});};xajax_consultar_liquidacionCompra=function(){return xajax.request({xjxfun:'consultar_liquidacionCompra'},{parameters:arguments});};xajax_genera_formulario_documentos=function(){return xajax.request({xjxfun:'genera_formulario_documentos'},{parameters:arguments});};xajax_update_comprobante=function(){return xajax.request({xjxfun:'update_comprobante'},{parameters:arguments});};xajax_firmar=function(){return xajax.request({xjxfun:'firmar'},{parameters:arguments});};xajax_validaAutoriza=function(){return xajax.request({xjxfun:'validaAutoriza'},{parameters:arguments});};xajax_autorizaComprobante=function(){return xajax.request({xjxfun:'autorizaComprobante'},{parameters:arguments});};xajax_firmar_factVent=function(){return xajax.request({xjxfun:'firmar_factVent'},{parameters:arguments});};xajax_firmar_notaCred=function(){return xajax.request({xjxfun:'firmar_notaCred'},{parameters:arguments});};xajax_firmar_notaDebi=function(){return xajax.request({xjxfun:'firmar_notaDebi'},{parameters:arguments});};xajax_firmar_guiaRemi=function(){return xajax.request({xjxfun:'firmar_guiaRemi'},{parameters:arguments});};xajax_firmar_reteGast=function(){return xajax.request({xjxfun:'firmar_reteGast'},{parameters:arguments});};xajax_firmar_reteInve=function(){return xajax.request({xjxfun:'firmar_reteInve'},{parameters:arguments});};xajax_firmar_factExpor=function(){return xajax.request({xjxfun:'firmar_factExpor'},{parameters:arguments});};xajax_firmar_factFlor=function(){return xajax.request({xjxfun:'firmar_factFlor'},{parameters:arguments});};xajax_firmar_factFlorExpor=function(){return xajax.request({xjxfun:'firmar_factFlorExpor'},{parameters:arguments});};xajax_firmar_guiaRemiFlor=function(){return xajax.request({xjxfun:'firmar_guiaRemiFlor'},{parameters:arguments});};xajax_firmar_liquidacionCompra=function(){return xajax.request({xjxfun:'firmar_liquidacionCompra'},{parameters:arguments});};xajax_enviar_factVent=function(){return xajax.request({xjxfun:'enviar_factVent'},{parameters:arguments});};xajax_enviar_notaCred=function(){return xajax.request({xjxfun:'enviar_notaCred'},{parameters:arguments});};xajax_enviar_notaDebi=function(){return xajax.request({xjxfun:'enviar_notaDebi'},{parameters:arguments});};xajax_enviar_guiaRemi=function(){return xajax.request({xjxfun:'enviar_guiaRemi'},{parameters:arguments});};xajax_enviar_reteGast=function(){return xajax.request({xjxfun:'enviar_reteGast'},{parameters:arguments});};xajax_enviar_reteInve=function(){return xajax.request({xjxfun:'enviar_reteInve'},{parameters:arguments});};xajax_enviar_factExpor=function(){return xajax.request({xjxfun:'enviar_factExpor'},{parameters:arguments});};xajax_enviar_factFlor=function(){return xajax.request({xjxfun:'enviar_factFlor'},{parameters:arguments});};xajax_enviar_factFlorExpor=function(){return xajax.request({xjxfun:'enviar_factFlorExpor'},{parameters:arguments});};xajax_enviar_guiaRemiFlor=function(){return xajax.request({xjxfun:'enviar_guiaRemiFlor'},{parameters:arguments});};xajax_enviar_liquCompras=function(){return xajax.request({xjxfun:'enviar_liquCompras'},{parameters:arguments});};xajax_updateError=function(){return xajax.request({xjxfun:'updateError'},{parameters:arguments});};xajax_update_comprobante=function(){return xajax.request({xjxfun:'update_comprobante'},{parameters:arguments});};xajax_genera_reporte=function(){return xajax.request({xjxfun:'genera_reporte'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_enviar_mail=function(){return xajax.request({xjxfun:'enviar_mail'},{parameters:arguments});};xajax_enviaEmail=function(){return xajax.request({xjxfun:'enviaEmail'},{parameters:arguments});};xajax_genera_busqueda_cliente=function(){return xajax.request({xjxfun:'genera_busqueda_cliente'},{parameters:arguments});};xajax_editar_contactos=function(){return xajax.request({xjxfun:'editar_contactos'},{parameters:arguments});};xajax_guardar_editar_contactos=function(){return xajax.request({xjxfun:'guardar_editar_contactos'},{parameters:arguments});};