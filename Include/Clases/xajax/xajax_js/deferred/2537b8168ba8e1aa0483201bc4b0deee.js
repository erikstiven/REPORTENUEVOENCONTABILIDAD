...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_genera_busqueda_paciente=function(){return xajax.request({xjxfun:'genera_busqueda_paciente'},{parameters:arguments});};xajax_generaFormVisitas=function(){return xajax.request({xjxfun:'generaFormVisitas'},{parameters:arguments});};xajax_guardarVisitas=function(){return xajax.request({xjxfun:'guardarVisitas'},{parameters:arguments});};