...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_genera_formulario_modifica_detalle=function(){return xajax.request({xjxfun:'genera_formulario_modifica_detalle'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_modificar=function(){return xajax.request({xjxfun:'modificar'},{parameters:arguments});};xajax_elimina_detalle=function(){return xajax.request({xjxfun:'elimina_detalle'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_modificar_item_general=function(){return xajax.request({xjxfun:'modificar_item_general'},{parameters:arguments});};xajax_modificar_item_general_line=function(){return xajax.request({xjxfun:'modificar_item_general_line'},{parameters:arguments});};xajax_modificar_item_general_modal=function(){return xajax.request({xjxfun:'modificar_item_general_modal'},{parameters:arguments});};xajax_procesar_info_promo=function(){return xajax.request({xjxfun:'procesar_info_promo'},{parameters:arguments});};xajax_eliminar_item_general_modal=function(){return xajax.request({xjxfun:'eliminar_item_general_modal'},{parameters:arguments});};xajax_ver_bodegas_activas=function(){return xajax.request({xjxfun:'ver_bodegas_activas'},{parameters:arguments});};