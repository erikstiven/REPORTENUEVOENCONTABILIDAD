...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_cargar_sucursal=function(){return xajax.request({xjxfun:'cargar_sucursal'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_reporte_fact=function(){return xajax.request({xjxfun:'reporte_fact'},{parameters:arguments});};xajax_genera_documento=function(){return xajax.request({xjxfun:'genera_documento'},{parameters:arguments});};xajax_reporte_reci=function(){return xajax.request({xjxfun:'reporte_reci'},{parameters:arguments});};xajax_reporte_cierre=function(){return xajax.request({xjxfun:'reporte_cierre'},{parameters:arguments});};xajax_aprobar=function(){return xajax.request({xjxfun:'aprobar'},{parameters:arguments});};