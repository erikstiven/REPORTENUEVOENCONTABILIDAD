...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_formulario=function(){return xajax.request({xjxfun:'genera_formulario'},{parameters:arguments});};xajax_reporte=function(){return xajax.request({xjxfun:'reporte'},{parameters:arguments});};xajax_reporte_facturas=function(){return xajax.request({xjxfun:'reporte_facturas'},{parameters:arguments});};xajax_reporte_anulados=function(){return xajax.request({xjxfun:'reporte_anulados'},{parameters:arguments});};xajax_form_filtros=function(){return xajax.request({xjxfun:'form_filtros'},{parameters:arguments});};xajax_cargar_mes=function(){return xajax.request({xjxfun:'cargar_mes'},{parameters:arguments});};