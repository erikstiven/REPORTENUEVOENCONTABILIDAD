...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_genera_cabecera_formulario=function(){return xajax.request({xjxfun:'genera_cabecera_formulario'},{parameters:arguments});};xajax_consultar=function(){return xajax.request({xjxfun:'consultar'},{parameters:arguments});};xajax_guardar=function(){return xajax.request({xjxfun:'guardar'},{parameters:arguments});};xajax_reporteArchivoExcel=function(){return xajax.request({xjxfun:'reporteArchivoExcel'},{parameters:arguments});};xajax_procesar=function(){return xajax.request({xjxfun:'procesar'},{parameters:arguments});};xajax_generaProvision=function(){return xajax.request({xjxfun:'generaProvision'},{parameters:arguments});};xajax_leer_excel=function(){return xajax.request({xjxfun:'leer_excel'},{parameters:arguments});};xajax_procesar_excel=function(){return xajax.request({xjxfun:'procesar_excel'},{parameters:arguments});};xajax_cargar_departamento=function(){return xajax.request({xjxfun:'cargar_departamento'},{parameters:arguments});};xajax_consulta_empleado=function(){return xajax.request({xjxfun:'consulta_empleado'},{parameters:arguments});};xajax_cargar_fecha_rol=function(){return xajax.request({xjxfun:'cargar_fecha_rol'},{parameters:arguments});};